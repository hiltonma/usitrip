...
define('HEADING_TEXT', 'Password Forgotten?');
...
define('TEXT_FORGOTTEN_ERROR', '<font color="#ff0000"><b>ERROR:</b></font> Email address does not match!');
...
define('ADMIN_EMAIL_TEXT', 'Hi %s,' . "\n\n" . 'You can access your account with the following detail. Once you access, please change your password immediately!' . "\n\n" . 'Website: %s' . "\n" . 'Username: %s' . "\n" . 'Password: %s' . "\n\n" . 'Thanks!' . "\n" . '%s' . "\n\n" . 'This is a system automated response, please do not reply, as your answer would be unread!');
?>