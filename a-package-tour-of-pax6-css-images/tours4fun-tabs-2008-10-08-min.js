...
{if(ifLoading)
{try
{var objDiv=document.getElementById(divID);objDiv.innerHTML="<span style='margin-left:15px;'><img src=ajaxtabs/loading.gif></span> <span class=sp6>Please later...</span>";}
