			  ...
			  ?> 
			   <tr class="moduleRow">
				<td width="59%" class="table_tc_list" >
					...
					//标题
					echo '<a  href="'.tep_href_link('new_bbs_travel_companion_content.php','TcPath='.$TcPath.'&t_companion_id='.(int)$dates[$i]['id']).'" target="_blank">'.db_to_html(tep_db_output($dates[$i]['title'])).'</a>';
					//目录
