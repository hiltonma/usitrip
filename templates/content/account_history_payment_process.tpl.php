...
3.<?php echo db_to_html('如果信用卡持卡人不是参与旅行团的成员，请附上游客的护照复印件或扫描件； <br>
					  ...
					  <tr>
                        ...
                        style="FONT-WEIGHT: bold; FONT-SIZE: 12px"><?php echo db_to_html('您可以通过以下方式提供相关证明')?></div></td>
                      </tr>
                      <tr>
...
<?php echo db_to_html('请点击<a href="' . tep_href_link('insurance.php') . '" target="_blank">旅游保险</a>，了解活动详情。')?> </p></td>
                          </tr>
						  <tr>
