...
throw({description:'垫虫㎝ず甧计秖ぃ癸莱'});for(var i=0;i<ls.length;i++){ls[i].index=i;if(i==index){ls[i].className='hovertabx';c[i].className='disx'
...
{this.element=this.getElement(element);if(typeof(Global_defaultTab)!='undefined'){this.defaultTab=Global_defaultTab;}else{this.defaultTab=0;}
this.bindings=[];this.tabSelectedClass="TabbedPanelsTabSelected";this.tabHoverClass="TabbedPanelsTabHover";this.tabFocusedClass="TabbedPanelsTabFocused";this.panelVisibleClass="TabbedPanelsContentVisible";this.focusElement=null;this.hasFocus=false;this.currentTabIndex=0;this.enableKeyboardNavigation=true;Spry.Widget.TabbedPanels.setOptions(this,opts);if(typeof(this.defaultTab)=="number")
