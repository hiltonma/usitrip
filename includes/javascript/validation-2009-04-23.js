		...
		if(Validation.isVisible(elm) && !v.test($F(elm), elm)) {
			...
			if(elm.addClassName('validation-passed')){
				...
				if(!elm.hasClassName('greenok')){
					...
					//alert(elm.id);					
					greenok = '<span id="greenok-'+elm.id+'" style="padding-left:4px; height:15px; paddding-bottom:0px; line-height:15px; vertical-align:bottom;"></span>';// style="padding-left:4px; float:left; height:18px; paddding-bottom:0px; line-height:15px; vertical-align:bottom; border:1px solid red;" background:transparent url(images/pixel_trans.gif) repeat-x;					
					new Insertion.After(elm, greenok);
					
				}else{
					var elmid = elm.id;
					if(document.getElementById('greenok-'+elmid).innerHTML==''){						
						document.getElementById('greenok-'+elmid).innerHTML = '<img src="image/right_icon.gif" />';
					}
				}
				}
			}
