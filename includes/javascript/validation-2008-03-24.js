		...
		if(Validation.isVisible(elm) && !v.test($F(elm), elm)) {
			if(!elm[prop]) {
				...
				if(advice == null) {
					...
					advice = '<div class="validation-advice" id="advice-' + name + '-' + Validation.getElmID(elm) +'" style="display:none;">' + errorMsg + '</div>'// padding-left:7px;
...
if(radio_error==null){
	var radio_error =  'Please select one of the above options.'
}
if(select_option_error==null){
	var select_option_error = 'Please make a selection.';
}
