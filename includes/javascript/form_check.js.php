...
<?php if (ACCOUNT_EMAIL_CONFIRMATION == 'true') { ?>  
  check_email_address("email_address", "c_email_address", <?php echo ENTRY_EMAIL_ADDRESS_MIN_LENGTH; ?>, "<?php echo ENTRY_EMAIL_ADDRESS_ERROR; ?>", "<?php echo ENTRY_CONFIRM_EMAIL_ADDRESS_CHECK_ERROR; ?>");
<?php }else{?>
  check_input("email_address", <?php echo ENTRY_EMAIL_ADDRESS_MIN_LENGTH; ?>, "<?php echo ENTRY_EMAIL_ADDRESS_ERROR; ?>");
<?php } ?>
