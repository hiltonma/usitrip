<?php
//取得农历的日期月日
//$datetime如为空则取当天日期，如五月初五
function chinese_lunar($datetime = ''){
#农历每月的天数
	$everymonth=array(
	...
	if($everymonth[$j][0]<>0 and $everymonth[$j][0]<$i){ //对闰月修补
	$mm=$i-1;
	}
	else{
	$mm=$i;
	...
	//$nowday=$mten[$everymonth[$j][14]].$mtwelve[$everymonth[$j][15]]."年".$nlmon.$nlday." ".$weekday[$cur_wday];
	$nowday=$nlmon.$nlday;

	return $nowday;
}
//echo chinese_lunar('2020-03-11');
?>