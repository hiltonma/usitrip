...
while($rows = tep_db_fetch_array($sql)){
	...
	//echo $rows['configuration_key'].':'.$rows['configuration_value']."<hr>";
}
//导入一些必要的函数库
require_once(INCLUDES_DIR."functions/webmakers_added_functions.php");
#require_once("E:/my_www/tff/trunk/includes/functions/webmakers_added_functions.php");
 
// Howard added }

define('API_USERNAME', MODULE_PAYMENT_PAYPAL_NVP_SAMPLES_API_USERNAME);
//
...
define('API_PASSWORD', MODULE_PAYMENT_PAYPAL_NVP_SAMPLES_API_PASSWORD);

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', MODULE_PAYMENT_PAYPAL_NVP_SAMPLES_API_SIGNATURE);

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/

define('API_ENDPOINT', MODULE_PAYMENT_PAYPAL_NVP_SAMPLES_API_ENDPOINT); //https://api-3t.paypal.com/nvp
...
/* Define the PayPal URL. This is the URL that the buyer is
   ...
   */
define('PAYPAL_URL', MODULE_PAYMENT_PAYPAL_NVP_SAMPLES_PAYPAL_URL);
