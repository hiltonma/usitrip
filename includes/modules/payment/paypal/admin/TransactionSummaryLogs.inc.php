...
?>
         <tr><td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr valign="top">
          ...
          <tr valign="top">
            <td class="main">
            <style type="text/css">.Txns{font-family: Verdana;font-size:12px;color: #000000;background-color: #aaaaaa;}.Txns td {padding: 2px 4px;}.TxnsTitle td {color: #000000;font-weight: bold;font-size: 13px;}.TxnsSTitle td{background-color: #ccddee;color: #000000;font-weight: bold;}</style>
            <script language="JavaScript">function openWindow(url,name,args) {if (url == null || url == '') exit;if (name == null || name == '') name = 'popupWin';if (args == null || args == '') args = 'toolbar,status,scrollbars,resizable,width=640,height=480,left=50,top=50';popupWin = window.open(url,name,args);popupWin.focus();}</script>
...
<?php
  ...
  if($order->info['orders_status'] === MODULE_PAYMENT_PAYPAL_ORDER_ONHOLD_STATUS_ID) {
    $ppImgAccept = tep_image(DIR_WS_CATALOG_LANGUAGES . '../modules/payment/paypal/images/act_accept.gif','Accept');
