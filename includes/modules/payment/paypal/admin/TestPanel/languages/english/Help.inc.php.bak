...
<table class="popupmain" cellspacing="0" cellpadding="0" border="0" align="center">
  ...
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="0" style="width: 100%; padding: 4px; border:1px solid #aaaaaa; background: #ffffcc url('<?php ; ?>') no-repeat top left;">
        <tr>
          <td><?php echo $page->image('bulb.gif','Error icon'); ?></td>
