...
// class methods
	  ...
	  //if (MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_INPUT_PAGE == 'Payment') {
        ...
        $selection['fields'] = array(array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_OWNER,
                                     ...
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_CVC,
                                           'field' => tep_draw_input_field('cc_cvc_nh-dns', '', 'size="5" maxlength="4"'). '<a href="javascript:CVVPopUpWindow(\'' . tep_href_link('cvv.html') . '\')">' .  '(' . MODULE_PAYMENT_AUTHORIZENET_TEXT_CVV_LINK . ')' . '</a>' ));
  ...
  <tr>
    ...
    <td height="22"><font color="#111">信用卡类型</font> <img src="image/icons/visa_icon.gif" style=" vertical-align:middle;" /> <img src="image/icons/master_icon.gif" style=" vertical-align:middle;" /> <img src="image/icons/discover_icon.gif" style=" vertical-align:middle;" /><br/>温馨提示：</td>
  </tr>
  <tr>
    <td height="22">1.请对照信用卡核对卡号,到期时间,CVV号;</td>
  </tr>
  <tr>
    <td height="22">2.严格按照信用卡显示格式填写持卡人姓名;</td>
  </tr>
  <tr>
    <td height="22">3.请确保信用卡剩余额度足够本次消费;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    function confirmation() {
      ...
      if (MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_INPUT_PAGE == 'Payment') {
        ...
        $months_array = array();
        for ($i=1; $i<13; $i++) {
          //$months_array[] = array('id' => sprintf('%02d', $i), 'text' => strftime('%B',mktime(0,0,0,$i,1,2000)));	//英文格式的月份
          $months_array[] = array('id' => sprintf('%02d', $i), 'text' => sprintf('%02d', $i) );	//数字格式的月份
        }
