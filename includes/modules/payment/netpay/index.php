...
<html>
	<head>
		<title>chinapay网上支付接口演示程序</title>
	</head>
<body>
<div style="text-align:center">
	<h1>chinapay网上支付接口演示程序</h1>
	<h2><a href="order_submit.php" target="_blank">支付交易</a></h2>
	<h2><a href="query_submit.php" target="_blank">单笔查询</a></h2>
	<h2><a href="refund_submit.php" target="_blank">单笔退款</a></h2>
	<hr>
<?php
	include_once("config.php");
	echo "<h2><font color='red'>本接口需要 mcrypt 和 bcmath 扩展库支持，请查看<a href='phpinfo.php' target='_blank'>PHP配置</a>，确认安装了这两个扩展。</font></h2>";
	
	echo "<h2>当前密钥配置：(<font color='red'>请按照您的实际情况在 config.php 中做适当修改</font>)</h2>";
