...
require(DIR_FS_LANGUAGES . $language . '/' . FILENAME_NEWSDESK_REVIEWS_ARTICLE);
...
select newsdesk_article_name from " . TABLE_NEWSDESK_DESCRIPTION . " where language_id = '" . $languages_id . "'
and newsdesk_id = '" . $HTTP_GET_VARS['newsdesk_id'] . "'
");
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="main"><?php echo sprintf(HEADING_TITLE, $product_info_values['newsdesk_article_name']); ?></td>
	</tr>
	<tr>
...
. TABLE_NEWSDESK_REVIEWS . " where approved='1' and newsdesk_id = '" . $HTTP_GET_VARS['newsdesk_id'] . "' order by reviews_id DESC
");
