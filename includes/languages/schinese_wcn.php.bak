...
define('TEXT_PARA_EXPERIENCED_DRIVER','我们拥有丰富的旅游服务的经验，我们了解您不愿意乘坐小型客车、吉普和有蓬货车去完成您3－10天的旅程。这就是我们为您提供宽敞舒适，装备豪华的大客车的原因。您可以一路享受根据气候调节的空调、可折叠的座位、独享的阅读灯、储物箱、VCD/DVD播放器和乾净的休息区. 我们的司机都有丰富的驾驶大客车的经验.');
...
define('MENU_LAS_VEGAS_TOURS','拉斯维加斯旅游');
define('MENU_SAN_FRANCISCO_TOURS','三藩市旅游');
define('MENU_LOS_ANGELES_TOURS','洛杉矶旅游');
define('MENU_GRAND_CANYON_TOURS','大峡谷旅游');
define('MENU_DISNELYLAND_TOURS','狄斯奈乐园旅游');
define('MENU_SAN_DIEGO_TOURS','圣地牙哥旅游');
...
define('MENU_RHODE_ISLAND_TOURS','美国罗德岛州旅游');
...
define('MENU_FLORIDA_TOURS_PACKAGES','佛罗里达打包旅游');


//Tours ByCity
define('MENU_LOSANGELES_TOURS','洛杉矶旅游');
define('MENU_LAS_VEGAS_TOURS','拉斯维加斯旅游');
define('MENU_SALT_LAKE_CITY_TOURS','盐湖城旅游');
define('MENU_SAN_FRANCISCO_TOURS','三藩市旅游');
define('MENU_NEW_YORK_TOURS','纽约旅游');
define('MENU_HONOLUU_TOURS','檀香山旅游');
define('MENU_ORLANDO_TOURS','奥兰多旅游');
define('MENU_PHILADEPHIA_TOURS','费城旅游');

//amit added for shopping cart start

define('TEXT_TOTAL_NO_OF_ROOMS','Total # of Rooms');
define('TEXT_OF_ADULTS_IN_ROOM','# of adults in room');
define('TEXT_OF_CHILDREN_IN_ROOM','# of children in room');
define('TEXT_TOTAL_OF_ROOM','Total of room');
define('TEXT_NO_ADULTS','# adults');
define('TEXT_NO_CHILDREN','# of children');
define('TEXT_TOTLAL','Total');
