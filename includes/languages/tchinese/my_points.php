...
define('NAVBAR_TITLE1', '積分獎勵概要');
define('NAVBAR_TITLE_2', '積分獎勵概要');
define('HEADING_TITLE', '歡迎您到Rewards4Fun激勵計劃！');
...
define('TEXT_DISPLAY_NUMBER_OF_RECORDS', '顯示 <b>%d</b> 至 <b>%d</b> （的 <b>%d</b> 條積分記錄）');

define('TEXT_INTRO_STRING_TOP','以下是您的積分統計和最近5項積分歷史記錄。 [<a href="' . tep_href_link('points_actions_history.php') . '">查看所有積分記錄</a>]');
define('TEXT_INTRO_STRING_BOTTOM','兌換方式： 在預定行程支付（checkout）過程中點擊“兌換積分”按鈕。 <br><br>');
define('TEXT_IMPROVE_INFO_FOR_POINT','完善個人基本信息（含郵箱驗證）--<strong>100</strong>積分。');
...
//define('TEXT_INTRO_STRING_BOTTOM','如想兌換積分，在結賬過程點擊 “兌換積分”按鈕即可實現。 <br><br>	
//如果您需要取得現金收入，請加盟我們 <a class="sp3" href="'.tep_href_link(FILENAME_JOIN_AFFILATE_PROGRAM_HTML).'">夥伴計劃</a>.');

/* English
define('NAVBAR_TITLE', 'Points Information');

define('HEADING_TITLE', 'Welcome to the Rewards4Fun Incentive Program!');
...
define('TEXT_INTRO_STRING_TOP','Below you will see your total points earned, and a list of your 5 most recent actions.');
define('TEXT_INTRO_STRING_BOTTOM','To redeem your points, just click the "Redeem Rewards" icon during the checkout process. <br><br>Interested in earning cash? Join-our <a class="sp3" href="'.tep_href_link(FILENAME_JOIN_AFFILATE_PROGRAM_HTML).'">affiliate program</a>.');
