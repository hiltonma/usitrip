...
define('NAVBAR_TITLE', '友情鏈接');
define('TEXT_LINK_TO_US', '友情鏈接');
define('TEXT_RESOURCE', '所有資源');
define('TEXT_LINKS_SUBMIT', '提交鏈接');

if ($display_mode == 'links') {
  define('HEADING_TITLE', '友情鏈接');
...
//amit added  
define('TEXT_HEADING_LINKS_US','link to us');
define('TEXT_ALL_RESOURCE','All Resource');
define('TEXT_LINK_SUBMIT','links submit');
?>