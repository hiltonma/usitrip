<?php
/*
  $Id: ot_shipping.php,v 1.1.1.1 2003/03/22 16:56:03 nickle Exp $
...
*/
  ...
  define('MODULE_ORDER_TOTAL_SHIPPING_TITLE', '¹B°e');
  define('MODULE_ORDER_TOTAL_SHIPPING_DESCRIPTION', '¹B¶O');
