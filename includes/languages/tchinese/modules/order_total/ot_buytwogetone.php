<?php
/*
  $Id: ot_tax.php,v 1.1.1.1 2003/03/22 16:56:03 nickle Exp $
...
*/
  ...
  define('MODULE_ORDER_TOTAL_BUYTWOGETONE_TITLE', '買二送一優惠');
  define('MODULE_ORDER_TOTAL_BUYTWOGETONE_DESCRIPTION', '買二送一返購');
?>