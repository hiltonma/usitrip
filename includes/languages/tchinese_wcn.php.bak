...
define('ENTRY_EMAIL_ADDRESS_ERROR', ' <small><font color="#FF0000">少於 ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' 個字</font></small>');
...
define('MENU_LAS_VEGAS_TOURS','拉斯維加斯旅遊');
define('MENU_SAN_FRANCISCO_TOURS','三藩市旅遊');
define('MENU_LOS_ANGELES_TOURS','洛杉磯旅遊');
define('MENU_GRAND_CANYON_TOURS','大峽谷旅遊');
define('MENU_DISNELYLAND_TOURS','狄斯奈樂園旅遊');
define('MENU_SAN_DIEGO_TOURS','聖地牙哥旅遊');
...
define('MENU_RHODE_ISLAND_TOURS','美國羅德島州旅遊');
define('MENU_SHENANDOAH_TOURS','維珍尼亞州仙人洞旅遊');
...
define('MENU_FLORIDA_TOURS_PACKAGES','佛羅里達打包旅遊');


//Tours ByCity
define('MENU_LOSANGELES_TOURS','洛杉磯旅遊');
define('MENU_LAS_VEGAS_TOURS','拉斯維加斯旅遊');
define('MENU_SALT_LAKE_CITY_TOURS','鹽湖城旅遊');
define('MENU_SAN_FRANCISCO_TOURS','三藩市旅遊');
define('MENU_NEW_YORK_TOURS','紐約旅遊');
define('MENU_HONOLUU_TOURS','檀香山旅遊');
define('MENU_ORLANDO_TOURS','奧蘭多旅遊');
define('MENU_PHILADEPHIA_TOURS','費城旅遊');
