...
if(HTTP_SERVER==SCHINESE_HTTP_SERVER){
	define('LANGUAGE_BUTTON','<li><a href="'.TW_CHINESE_HTTP_SERVER.$_SERVER['REQUEST_URI'].'" title="访问繁体版的usitrip" >繁体</a></li><li class="us" style="display:none"><a href="http://208.109.123.18/" title="to usitrip">English</a></li>');
	...
	define('LANGUAGE_BUTTON','<li><a href="'.HTTP_SERVER.preg_replace('/(&*)language=(tw|sc)(&*)/','',$_SERVER['REQUEST_URI']).$strlink.'language=tw'.'" title="访问繁体版的usitrip">繁体</a></li><li class="us" style="display:none"><a href="http://208.109.123.18/" title="to usitrip" >English</a></li>');
