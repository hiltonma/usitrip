...
//home page
define('TEXT_HEADING_SPECIAL_OFFERS','特别优惠');
define('TEXT_HEADING_WEATHER','天气');
define('TEXT_HEADING_POWERED_BY_YAHOO','由雅虎提供');
define('TEXT_HEADING_ENTER_US_ZIP_CODE','请输入美国城市邮编');
define('TEXT_HEADING_BY_DEPARTURE_CITY','按出发城市分类');
define('TEXT_NOTES_REVIEW_HOME_PAGE','我写信来感谢贵公司上周为我们提供的从洛杉矶到三藩市和优胜美地的旅行如此美妙┅┅');
define('TEXT_HEADING_SEE_MORE','更多┅');
define('TEXT_TOP_TOUR_PACKAGE_DEALS','热门旅游一览');

//home page added 2008-04-11
define('NO_PREFERENCE','无指定景点');
