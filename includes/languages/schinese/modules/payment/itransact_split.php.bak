...
// Defines the payment options shown to the customer.  For example, you could change "Checking Account" to "EFT" but it may confuse your customers, since most don't know what EFT or ACH is.  The final values are defined based on what iTransact payment types you have defined in admin.
  if (MODULE_PAYMENT_ITRANSACT_SPLIT_CARDS <> 0) $card_text = "信用卡（美元）";
  ...
  define('MODULE_PAYMENT_ITRANSACT_SPLIT_TEXT_DESCRIPTION', '信用卡测试∶<br><br>CC#: 5454545454545454<br>到期日∶ Any<br>支票ABA号码∶ 124000054<br>户名∶ 12345<br><br><b>&gt;&gt; <a href="https://secure.itransact.com/support/login.html" target="_blank"><u>Gateway Link</u></a></b>');

  define('HEADING_TITLE', '您的结帐已经完成！');
...
// Text to show to customer on checkout_process.php.
  define('MODULE_PAYMENT_ITRANSACT_SPLIT_CHECKOUT_PROCESS_TEXT', "您的交易已经完成，如果" . MODULE_PAYMENT_ITRANSACT_SPLIT_CHECKOUT_PROCESS_DELAY_SECONDS . "秒内没有自动前往下页，请按连结");
