<?php
/*
  $Id: ot_loworderfee.php,v 1.1.1.1 2003/03/22 16:56:03 nickle Exp $
...
*/
  ...
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_TITLE', '单笔订单价格过低处理费');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_DESCRIPTION', '单笔订单价格过低处理费');
?>