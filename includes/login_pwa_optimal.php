...
<table width="100%" height="250" border="0" cellpadding="2" cellspacing="0" class="infoBoxContents">
                    ...
                    <td class="main" colspan="2"><?php echo TEXT_RETURNING_CUSTOMER; ?></td>
                        ...
                        <tr valign="top">
                          ...
                          <td height="50" class="main"><?php echo tep_draw_input_field('email_address','',' class="sign_in_box"'); ?></td>
                        </tr>
                        <tr valign="top">
                          <td height="50" class="main"><b><?php echo ENTRY_PASSWORD; ?></b></td>
                          <td height="50" class="main"><?php echo tep_draw_password_field('password','',' class="sign_in_box"'); ?></td>
                        </tr>
                        <tr valign="top">
                          <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                        </tr>
                        <tr valign="top">
                          <td colspan="2" class="smallText"><?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '"  style="text-decoration:underline;">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></td>
                        </tr>
                        <tr valign="bottom">
