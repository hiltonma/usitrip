...
#### Points/Rewards Module V2.1rc2a BOF ####
  if (USE_REDEEM_SYSTEM == 'true') {
	  ...
	  if ($has_points > 0) {
		  $info_box_contents[] = array('align' => 'left','text' => tep_draw_separator());
		  $info_box_contents[] = array('align' => 'center','text' => '<table cellpadding="0" width="100%" cellspacing="0" border="0"><tr><td align="center" class="smalltext"><b><a href="' . tep_href_link(FILENAME_MY_POINTS, '', 'SSL') . '">'. TEXT_POINTS_BALANCE . '</a></b></tr></td><tr><td class="smalltext" align="right" valign="bottom">' . TEXT_POINTS .'&nbsp;'. number_format($has_points,POINTS_DECIMAL_PLACES) .'</tr></td><tr><td class="smalltext" align="right" valign="bottom">' .  TEXT_VALUE . $currencies->format(tep_calc_shopping_pvalue($has_points)) . '</td></tr></table>');
	  }
  }
