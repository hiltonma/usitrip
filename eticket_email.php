...
<?php
//航班信息 start{
$orders_history_query = tep_db_query("select * from ".TABLE_ORDERS_PRODUCTS_FLIGHT." where orders_id = '" . tep_db_input($oID) . "'  and  orders_products_id=".$order->products[$i]['orders_products_id']." and (airline_name != '' or airline_name_departure != '' or flight_no != '' or flight_no_departure != '' or airport_name != '' or airport_name_departure != '') ");//orders_id = '" . tep_db_input($oID) . "'  and products_id=".$_GET['products_id']."
	...
	<tbody>
    	<tr style="line-height:24px;font-family:Tahoma;font-weight:bold;font-size:12px;color:#000099;">
        	<td style="border-top:3px solid #000099;text-align:left;">
            	<p style="margin:0;padding:0;">美加(热线):888-887-2816  国际热线:1-626-898-7800<br />中国(热线):4006-333-926  </p>
            </td>
