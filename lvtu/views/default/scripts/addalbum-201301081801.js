...
$.jBox.setDefaults(jBoxConfig); (function($) {
...
$(function() {
	...
	$("#albumName").blur(function() {
		...
		if ($("#albumName").val() != null && $.trim($("#albumName").val()) != "") {
			$.getJSON("/lvtu/?module=album&action=check", b,
			function(c) {
				if (c.isReName == true) {
					doubble = false;
				} else {
...
$(function() {
	$("#albumName").bind("keyup paste keydown",
	function() {
	...
	$("#description").bind("keyup paste keydown",
	function() {
		var curLength = $.trim($(this).val()).length;
		worldlenDesc = 140;
...
$(document).ready(function() {
	$("#id_upload").uploadify({
		...
		buttonImage: "lvtu/views/default/image/specialadd_one.jpg",
	...
	$("#addressId").tokenInput("/lvtu/?module=album&action=searchDestin",{
		searchDelay: 0,
		animateDropdown: false,
		theme: "facebook"
	});
	$("#psAddressId").tokenInput("/lvtu/?module=album&action=searchPOI", {
		theme: "facebook",
		tokenLimit: 1
	});
});
...
function upload1(a, b) {
	$("#id_upload" + a).uploadify({
		...
		swf: pathUpload + "views/default/image/uploadify.swf",//SWFUpload.swf",
		uploader: pathUpload + "?module=album&action=upimg",
		buttonImage: "lvtu/views/default/image/special_add.jpg",
		fileTypeExts: "*.jpg; *.png; *.jpeg;",
		fileObjName: "myfile",
		width: 186,
		queueSizeLimit: 30,
...
function upload(a) {
	$("#id_upload" + a).uploadify({
		...
		buttonImage: "lvtu/views/default/image/specialadd_next.jpg",
		fileTypeExts: "*.jpg; *.png; *.jpeg;",
		fileObjName: "myfile",
		debug:false,
		width: 126,
		...
		removeCompleted: false,
		onInit: function(b) {
			$("#batch" + a).find("input[name='batchdes']").tokenInput("/lvtu/?module=album&action=searchPOI&b=2", {
				theme: "facebook",
				tokenLimit: 1
			});
			$("#finish").attr("class", "jk_upload_undone ml15 mb15 mr15 fn-tc");
...
function uploadFilter() {
	$(".testaaa").tokenInput("web/searchPOI.htm", {
		theme: "facebook",
		tokenLimit: 1
	});
...
$(function() {
	$("#token-input-addressId").focus(function() {
