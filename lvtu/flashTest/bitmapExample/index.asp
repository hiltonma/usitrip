...
Class Cls_Exif
	...
	Private Sub LoadImage(picFile)
		...
		End If
		Response.Write("Offset_to_TIFF=" & Offset_to_TIFF & "<br/>")
		Response.Write("Offset_to_IFD0=" & Offset_to_IFD0 & "<br/>")
		IsLoaded = True
		...
		If Not FileName = "" Then
			...
			If FSO.FileExists(FileName) Then
				...
				While Not File.EOS And SOSFound = False
					...
					End If
					ExifTemp(i) = CurByte
					'Response.Write(Hex0(CurByte) & "<br/>")
					i = i + 1
			...
			End If
			Set FSO = Nothing
			Response.Write("ExifTemp.Length = " & Ubound(ExifTemp) & "<br/>")
		End If
	End Function
	...
	Private Sub GetDirectoryEntries(Offset)
		...
		Do
			...
			End If
			Response.Write("No_of_Entries=" &  No_of_Entries & "<br/>")
			...
			For i = 1 To No_of_Entries
				...
				If IsIntel Then
					...
					Select Case IFDDirectory(k)(IFD_IDX_Data_Format)
						...
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							...
							Response.Write("==== 1--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						...
						Else
							...
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
								...
								Response.Write("==== 2--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = "00"
								Response.Write("==== 3--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						...
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							...
							Response.Write("==== 4--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						Else
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = ByteToLong(ExifTemp((Offset + 2) + ((i - 1) * 12) + 11), ExifTemp((Offset + 2) + ((i - 1) * 12) + 10), ExifTemp((Offset + 2) + ((i - 1) * 12) + 9), ExifTemp((Offset + 2) + ((i - 1) * 12) + 8))
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
								...
								Response.Write("==== 5--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = ""
								Response.Write("==== 6--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						...
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							Select Case IFDDirectory(k)(IFD_IDX_Components)
								...
								Response.Write("==== 7--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
								Case 2
								...
								Response.Write("==== 8--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End Select
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = 0
						Else
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = ByteToLong(ExifTemp((Offset + 2) + ((i - 1) * 12) + 11), ExifTemp((Offset + 2) + ((i - 1) * 12) + 10), ExifTemp((Offset + 2) + ((i - 1) * 12) + 9), ExifTemp((Offset + 2) + ((i - 1) * 12) + 8))
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
								IFDDirectory(k)(IFD_IDX_Value) = ByteToByte(Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue), Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) + IFDDirectory(k)(IFD_IDX_Components) - 1)
								Response.Write("==== 9--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = 0
								Response.Write("==== 10--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						Case m_LONG, m_SLONG
						BytesPerComponent = 4
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							...
							Response.Write("==== 11--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = 0
						Else
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = ByteToLong(ExifTemp((Offset + 2) + ((i - 1) * 12) + 11), ExifTemp((Offset + 2) + ((i - 1) * 12) + 10), ExifTemp((Offset + 2) + ((i - 1) * 12) + 9), ExifTemp((Offset + 2) + ((i - 1) * 12) + 8))
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
								IFDDirectory(k)(IFD_IDX_Value) = ByteToByte(Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue), Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) + IFDDirectory(k)(IFD_IDX_Components) - 1)
								Response.Write("==== 12--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = 0
								Response.Write("==== 13--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						...
						If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
							...
							Response.Write("==== 14--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						Else
							IFDDirectory(k)(IFD_IDX_Value) = "0/0"
							Response.Write("==== 15--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						End If
					End Select
				Else
					...
					Select Case IFDDirectory(k)(IFD_IDX_Data_Format)
						...
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = 0
							IFDDirectory(k)(IFD_IDX_Value) = ByteToByte((Offset + 2) + ((i - 1) * 12) + 8, (Offset + 2) + ((i - 1) * 12) + 8 + IFDDirectory(k)(IFD_IDX_Components) - 1)
							Response.Write("==== 16--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						Else
							...
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
								IFDDirectory(k)(IFD_IDX_Value) = ByteToByte(Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue), Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) + IFDDirectory(k)(IFD_IDX_Components) - 1)
								Response.Write("==== 17--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = "00"
								Response.Write("==== 18--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						Case m_STRING, m_UNDEFINED
						BytesPerComponent = 1
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = 0
							IFDDirectory(k)(IFD_IDX_Value) = ByteToStr((Offset + 2) + ((i - 1) * 12) + 8, (Offset + 2) + ((i - 1) * 12) + 8 + IFDDirectory(k)(IFD_IDX_Components) - 1)
							Response.Write("==== 19--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						Else
						    Response.Write(Hex0(ExifTemp(Offset + 2 + ((i-1) * 12) + 8)) & "<br/>")
						    Response.Write(Hex0(ExifTemp((Offset + 2) + ((i - 1) * 12) + 9)) & "<br/>")
						    Response.Write(Hex0(ExifTemp((Offset + 2) + ((i - 1) * 12) + 10)) & "<br/>")
						    Response.Write(Hex0(ExifTemp((Offset + 2) + ((i - 1) * 12) + 11)) & "<br/>")
						    Response.End
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = ByteToLong(ExifTemp((Offset + 2) + ((i - 1) * 12) + 8), ExifTemp((Offset + 2) + ((i - 1) * 12) + 9), ExifTemp((Offset + 2) + ((i - 1) * 12) + 10), ExifTemp((Offset + 2) + ((i - 1) * 12) + 11))
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
							    Response.Write("Offset_to_TIFF=" & Offset_to_TIFF & "<br/>")
							    Response.Write("IFDDirectory(k)(IFD_IDX_OffsetToValue)=" & IFDDirectory(k)(IFD_IDX_OffsetToValue) & "<br/>")
							    Response.Write("IFDDirectory(k)(IFD_IDX_Components)=" & IFDDirectory(k)(IFD_IDX_Components) & "<br/>")
								IFDDirectory(k)(IFD_IDX_Value) = ByteToStr(Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue), Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) + IFDDirectory(k)(IFD_IDX_Components) - 1)
								Response.Write("==== 20--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = ""
								Response.Write("==== 21--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						Case m_SHORT, m_SSHORT
						BytesPerComponent = 2
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							Select Case IFDDirectory(k)(IFD_IDX_Components)
								...
								Response.Write("==== 22--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
								Case 2
								...
								Response.Write("==== 23--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End Select
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = 0
						Else
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = ByteToLong(ExifTemp((Offset + 2) + ((i - 1) * 12) + 8), ExifTemp((Offset + 2) + ((i - 1) * 12) + 9), ExifTemp((Offset + 2) + ((i - 1) * 12) + 10), ExifTemp((Offset + 2) + ((i - 1) * 12) + 11))
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
								...
								Response.Write("==== 24--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = 0
								Response.Write("==== 25--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						Case m_LONG, m_SLONG
						BytesPerComponent = 4
						If IFDDirectory(k)(IFD_IDX_Components) * BytesPerComponent <= 4 Then
							...
							Response.Write("==== 26--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = 0
						Else
							IFDDirectory(k)(IFD_IDX_OffsetToValue) = ByteToLong(ExifTemp((Offset + 2) + ((i - 1) * 12) + 8), ExifTemp((Offset + 2) + ((i - 1) * 12) + 9), ExifTemp((Offset + 2) + ((i - 1) * 12) + 10), ExifTemp((Offset + 2) + ((i - 1) * 12) + 11))
							If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
								IFDDirectory(k)(IFD_IDX_Value) = ByteToByte(Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) + IFDDirectory(k)(IFD_IDX_Components) - 1, Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue))
								Response.Write("==== 27--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							Else
								IFDDirectory(k)(IFD_IDX_Value) = 0
								Response.Write("==== 28--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
							End If
						End If
						Case m_RATIONAL, m_SRATIONAL
						BytesPerComponent = 8
						...
						If Offset_to_TIFF + IFDDirectory(k)(IFD_IDX_OffsetToValue) < UBound(ExifTemp) Then
							...
							Response.Write("==== 29--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						Else
							IFDDirectory(k)(IFD_IDX_Value) = "0/0"
							Response.Write("==== 30--- ====== IFDDirectory("&k&")(IFD_IDX_Value) = " & IFDDirectory(k)(IFD_IDX_Value) & "<br/>")
						End If
					End Select
				End If
				...
				If IFDDirectory(k)(IFD_IDX_Tag_No) = ExifOffset Then
					...
					Response.Write("==== Offset_to_ExifSUbIFD = " & Offset_to_ExifSubIFD & "<br/>")
				End If
			...
			If IsIntel Then
				If Not Processed_ExifSubIFD Then
					...
					Response.Write("1位置 Offset_to_Next_IFD = " & Offset_to_Next_IFD & "<br/>")
				Else
					Offset_to_Next_IFD = 0
					Response.Write("2位置 Offset_to_Next_IFD = " & Offset_to_Next_IFD & "<br/>")
				End If
			Else
				If Not Processed_ExifSubIFD Then
					...
					Response.Write("3位置 Offset_to_Next_IFD = " & Offset_to_Next_IFD & "<br/>")
				Else
					Offset_to_Next_IFD = 0
					Response.Write("4位置 Offset_to_Next_IFD = " & Offset_to_Next_IFD & "<br/>")
				End If
			End If
			If Offset_to_Next_IFD = 0 And Processed_ExifSubIFD = False Then
			    Response.Write("Offset_to_ExifSubIFD=" & Offset_to_ExifSubIFD & "<br/>")
				Offset_to_Next_IFD = Offset_to_ExifSubIFD
				Response.Write("5位置 Offset_to_Next_IFD = " & Offset_to_Next_IFD & "<br/>")
			...
			ElseIf Processed_ExifSubIFD = False Then
				If Offset_to_TIFF + Offset_to_Next_IFD + 2 > UBound(ExifTemp) Then
					Offset_to_Next_IFD = Offset_to_ExifSubIFD
					Response.Write("6位置 Offset_to_Next_IFD = " & Offset_to_Next_IFD & "<br/>")
					Processed_ExifSubIFD = True
				End If
			End If
			Offset = Offset_to_TIFF + Offset_to_Next_IFD
			Response.Write("Offset_to_Next_IFD=" & Offset_to_Next_IFD & "<br/>")
		...
		Else
			For i = StartOffset To EndOffset
				...
				If i < EndOffset Then
					...
					Else
						ByteToStr = ByteToStr & Chr(ExifTemp(i))
						Response.Write("=" & ExifTemp(i) & "=" & ByteToStr & "=<br/>")
					End If
				Else
					ByteToStr = ByteToStr & Chr(ExifTemp(i))
				End If
	...
	Private Function MakeSenseOfMeaninglessValues()
		...
		For x = 0 To UBound(IFDDirectory) - 1
		    Response.Write(IFDDirectory(x)(IFD_IDX_Tag_Name) & "<br/>")
