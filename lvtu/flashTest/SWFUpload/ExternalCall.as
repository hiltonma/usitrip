package 
{
    ...
    class ExternalCall extends Object
    {
        ...
        public static function FileQueued(param1:String, param2:Number, param3:Object, param4:String) : void
        {	
			if (ExternalCall.test) {
				
			} else {
            	ExternalInterface.call(param1, param2,EscapeMessage(param3), EscapeMessage(param4));
			}
            return;
        }// end function
        ...
        {
            return true;//ExternalInterface.call(param1);
        }// end function
