<?php
  ...
  $breadcrumb->add(LATEST_TRAVEL_COMPANION_BBS, tep_href_link('latest_bbs.php', '', 'SSL'));
...
$sql_str = 'SELECT * FROM `travel_companion` WHERE `status`="1" '.$where.' ORDER BY '.$order_by.' '.$a_d.' ';
