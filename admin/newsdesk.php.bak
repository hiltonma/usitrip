...
$languages = tep_get_languages();
for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
	echo tep_draw_hidden_field('newsdesk_article_name[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_article_name[$languages[$i]['id']])));
	echo tep_draw_hidden_field('newsdesk_article_description[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_article_description[$languages[$i]['id']])));
	echo tep_draw_hidden_field('newsdesk_article_shorttext[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_article_shorttext[$languages[$i]['id']])));
	echo tep_draw_hidden_field('newsdesk_article_url[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_article_url[$languages[$i]['id']])));
	echo tep_draw_hidden_field('newsdesk_article_url_name[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_article_url_name[$languages[$i]['id']])));
	echo tep_draw_hidden_field('newsdesk_image_text[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_image_text[$languages[$i]['id']])));
	echo tep_draw_hidden_field('newsdesk_image_text_two[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_image_text_two[$languages[$i]['id']])));
	echo tep_draw_hidden_field('newsdesk_image_text_three[' . $languages[$i]['id'] . ']', tep_htmlspecialchars(stripslashes($newsdesk_image_text_three[$languages[$i]['id']])));
}
