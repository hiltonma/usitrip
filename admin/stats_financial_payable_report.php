...
if($_GET['ajax']=="true"){
	...
	$remark = new Remark('stats_financial_payable_report');
...
//echo $login_id;
include DIR_FS_CLASSES . 'Remark.class.php';
$listrs = new Remark('stats_financial_payable_report');
...
<table border="0" width='100%' cellspacing="0" cellpadding="2">
						<tr>
							...
							<td colspan="9" valign="top">
								<?php echo tep_draw_form('search', FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, '', 'get'); ?>
...
//--></script>
								<table width="99%"  cellpadding="2" cellspacing="0" border="0">
									...
									<td>&nbsp;</td>  
										<td>
											...
											//echo '<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('selected_box','action')).'action=view_report', 'NONSSL') . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a>';
											}else{
											echo '<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a>';
											}
						...
						<tr class="dataTableHeadingRow">
							...
							<td class="dataTableHeadingContent" width="5%">
								Charge Captured Date <?php echo '<br><a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=orderdate&order=ascending', 'NONSSL').'"><img src="'.DIR_WS_IMAGES.'arrow_up.gif" border="0"></a>&nbsp;<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=orderdate&order=decending', 'NONSSL').'"><img src="'.DIR_WS_IMAGES.'arrow_down.gif" border="0"></a>'; ?>  
							</td>
							<td class="dataTableHeadingContent">Tours</td>
							<td class="dataTableHeadingContent">Provider</td>
							<td class="dataTableHeadingContent">
							 <?php //echo 'Invoiced#<br><a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=invoice&order=ascending', 'NONSSL').'"><img src="images/arrow_up.gif" border="0"></a>&nbsp;<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=invoice&order=decending', 'NONSSL').'"><img src="images/arrow_down.gif" border="0"></a>'; ?>  
							<?php
							...
							<td class="dataTableHeadingContent">
							Depature Date <?php echo '<br><a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=deptdate&order=ascending', 'NONSSL').'"><img src="'.DIR_WS_IMAGES.'arrow_up.gif" border="0"></a>&nbsp;<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=deptdate&order=decending', 'NONSSL').'"><img src="'.DIR_WS_IMAGES.'arrow_down.gif" border="0"></a>'; ?> 
							</td>
							<td class="dataTableHeadingContent">
							Order# <?php echo '<br><a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=orderno&order=ascending', 'NONSSL').'"><img src="'.DIR_WS_IMAGES.'arrow_up.gif" border="0"></a>&nbsp;<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=orderno&order=decending', 'NONSSL').'"><img src="'.DIR_WS_IMAGES.'arrow_down.gif" border="0"></a>'; ?> 
							</td>
				...
				/////   start - search coding    ///////
						$where = ' 1=1 ';
						  ...
						  $where .= " and  os.date_added >= '" . $make_start_date . "' and os.date_added <= '" . $make_end_date . "' ";
						  ...
						  $where .= " and os.date_added >= '" . $make_start_date . "' ";
						 ...
						 $make_end_date = tep_get_date_db($HTTP_GET_VARS['dept_end_date']) . " 00:00:00";
							...
							$where .= " and os.date_added <= '" . $make_end_date . "' ";
				...
				/////   end - search coding    ///////
							...
							if($_GET["sort"] == 'invoice'){
							 $prods_query_sql = "select p.agency_id, p.provider_tour_code, o.orders_id, o.orders_status, o.date_purchased, op.orders_products_id, op.payment_paid, op.products_id, op.products_model, op.products_name, op.final_price, op.products_quantity, op.final_price_cost,op.products_departure_date, op.orders_products_id, oph.cost, oph.retail, oph.last_updated_date, oph.invoice_number, oph.invoice_amount, oph.updated_by, oph.comment, os.date_added, opph.payment_date  from  orders as o LEFT JOIN ".TABLE_ORDERS_STATUS_HISTORY." os on os.orders_id = o.orders_id LEFT JOIN ".TABLE_ORDERS_STATUS_HISTORY." os2 ON os.orders_id = o.orders_id and os.orders_id = os2.orders_id
AND os.orders_status_history_id < os2.orders_status_history_id AND os.date_added < os2.date_added, products as p, ".TABLE_ORDERS_PRODUCTS." as op LEFT JOIN ".TABLE_ORDERS_PRODUCTS_PAYMENT_HISTORY." opph on cast(opph.orders_products_id as signed) = op.orders_products_id LEFT JOIN ".TABLE_ORDERS_PRODUCTS_PAYMENT_HISTORY." opph2 ON cast(opph.orders_products_id as signed) = op.orders_products_id and opph.orders_products_id = opph2.orders_products_id
AND opph.ord_prod_payment_id < opph2.ord_prod_payment_id AND opph.last_update_date < opph2.last_update_date, ".TABLE_ORDERS_PRODUCTS_UPDATE_HISTORY." oph LEFT JOIN ".TABLE_ORDERS_PRODUCTS_UPDATE_HISTORY." oph2 ON oph.orders_products_id = oph2.orders_products_id
AND oph.ord_prod_history_id < oph2.ord_prod_history_id and oph.last_updated_date < oph2.last_updated_date where ".$where." and oph2.last_updated_date IS NULL and oph.orders_products_id = op.orders_products_id and op.orders_id = o.orders_id and  op.products_id=p.products_id and os2.date_added IS NULL and opph2.last_update_date IS NULL and os.orders_status_id = o.orders_status and o.orders_status = '100006' and (op.payment_paid='0' or (opph.payment_date > '" . $make_end_date . "' )) order by ".$sortorder." ";
							}else{
							 $prods_query_sql = "select p.agency_id, p.provider_tour_code, o.orders_id, o.orders_status, o.date_purchased, op.orders_products_id, op.payment_paid, op.products_id, op.products_model, op.products_name, op.final_price, op.products_quantity, op.final_price_cost,op.products_departure_date, op.orders_products_id, os.date_added, opph.payment_date from orders_products as op LEFT JOIN ".TABLE_ORDERS_PRODUCTS_PAYMENT_HISTORY." opph on cast(opph.orders_products_id as signed) = op.orders_products_id LEFT JOIN ".TABLE_ORDERS_PRODUCTS_PAYMENT_HISTORY." opph2 ON cast(opph.orders_products_id as signed) = op.orders_products_id and opph.orders_products_id = opph2.orders_products_id
AND opph.ord_prod_payment_id < opph2.ord_prod_payment_id AND opph.last_update_date < opph2.last_update_date,
products as p, orders as o LEFT JOIN ".TABLE_ORDERS_STATUS_HISTORY." os on os.orders_id = o.orders_id LEFT JOIN ".TABLE_ORDERS_STATUS_HISTORY." os2 ON os.orders_id = o.orders_id and os.orders_id = os2.orders_id
AND os.orders_status_history_id < os2.orders_status_history_id AND os.date_added < os2.date_added where  ".$where." and op.orders_id = o.orders_id and os2.date_added IS NULL and opph2.last_update_date IS NULL and os.orders_status_id = o.orders_status and op.products_id=p.products_id and o.orders_status = '100006' and (op.payment_paid='0' or (opph.payment_date > '" . $make_end_date . "' )) order by ".$sortorder."";
						    }
							 ...
							 while ($prods = tep_db_fetch_array($prods_query)) {
									...
									<td class="dataTableContent"><?= tep_date_short($prods['date_added']); ?></td>
...
<?php
	...
	$count = 0;
		$years_query = tep_db_query( "SELECT DISTINCT( year( date_added ) ) AS y FROM " . TABLE_ORDERS_STATUS_HISTORY . " where orders_status_id = '100006' ORDER BY date_added DESC limit 2" );
...
?>
						...
						<tr class="dataTableHeadingRow">
							<td class="dataTableHeadingContent" width="30%" ><?php echo TABLE_HEADING_CHARGE_CAPTURED_MONTH;?></td>
							<td class="dataTableHeadingContent" align="right">Unpaid Invoiced Amount</td>
							<td class="dataTableHeadingContent" align="right">Cost Amount <?php //echo '<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=cost&order=ascending', 'NONSSL').'"><img src="images/arrow_up.gif" border="0"></a>&nbsp;<a href="' . tep_href_link(FILENAME_STATS_FINANCIAL_PAYABLE_REPORT, tep_get_all_get_params(array('sort','order')).'sort=cost&order=decending', 'NONSSL').'"><img src="images/arrow_down.gif" border="0"></a>'; ?>  </td>
...
<?
		...
		$total_unpaid_amount = 0;
			...
			$months_query = tep_db_query( "SELECT DISTINCT( monthname( os.date_added ) ) AS month, month( os.date_added ) AS m FROM " . TABLE_ORDERS_PRODUCTS . " op, ".TABLE_ORDERS." o, ".TABLE_ORDERS_STATUS_HISTORY." os WHERE os.date_added LIKE '" . $years['y'] . "-%' and os.date_added != '0000-00-00 00:00:00' and (op.payment_paid = '0') and op.orders_id = o.orders_id and o.orders_status = os.orders_status_id and o.orders_id = os.orders_id and o.orders_status = '100006' ORDER BY os.date_added DESC" );
		
		while ( $months = tep_db_fetch_array( $months_query ) ) {
			
				$where = "  and  year( os.date_added ) = " . $years['y'] . " AND month( os.date_added ) = " . $months['m'] . " "; //and o.orders_status!='6'
...
AND oph.ord_prod_history_id < oph2.ord_prod_history_id and oph.last_updated_date < oph2.last_updated_date, products as p, orders as o LEFT JOIN ".TABLE_ORDERS_STATUS_HISTORY." os on os.orders_id = o.orders_id LEFT JOIN ".TABLE_ORDERS_STATUS_HISTORY." os2 ON os.orders_id = o.orders_id and os.orders_id = os2.orders_id
AND os.orders_status_history_id < os2.orders_status_history_id AND os.date_added < os2.date_added where oph2.last_updated_date IS NULL ".$where."  and oph.orders_products_id = op.orders_products_id  and op.orders_id = o.orders_id and os2.date_added IS NULL and os.orders_status_id = o.orders_status and op.products_id=p.products_id  and op.payment_paid='0' and o.orders_status = '100006'"; //o.last_modified desc
			//echo "<br/>";							
			$prods_query = tep_db_query($prods_query_sql);
...
?>
						...
						<tr <?php if( ($prods['total_invoice_amount'] != $prods['total_cost_amount']) ){echo 'class="dataTableRowSelectedPink"';}else{ echo 'class="dataTableRow"';} ?>>
							<td class="dataTableContent">
							<?php
							$link = 'stats_financial_payable_report.php?dept_start_date='.$dept_start_date.'&dept_end_date='.$dept_end_date.'&action=view_report&list_by=departure';
							?>
