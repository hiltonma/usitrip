...
<title>Valid Categories List - usitrip</title>
<head>
<body marginwidth="10" marginheight="10" topmargin="10" bottommargin="10" leftmargin="10" rightmargin="10">
 
	<table width="760" class="infoBoxContents">
<tr>
<td colspan="2" align="right" >
<?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_VALIDPRODS_CATES) . '"><b>View Categories</b></a>'; ?>
</td>
</tr>	
