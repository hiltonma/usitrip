<?php
  ...
  if($_GET['ajax']=="true"){
  	...
  	$remark = new Remark('famous_attraction_subcategories');
    ...
    switch ($HTTP_GET_VARS['action']) {
      ...
      case 'delete_tour_type_confirm' : //user has confirmed deletion of news article.
        ...
        if ($HTTP_POST_VARS['fam_prod_id']) {
          ...
          tep_db_query("delete from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES . " where fam_prod_id = '" . tep_db_input($fam_prod_id) . "'");
	   }



        //tep_redirect(tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES)); 
		tep_redirect(tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES));
      ...
      case 'addtourproccess': //insert a new news article.
           ...
           $sql_data_array = array( 
								  ...
								  'fam_subcat_ids'   => tep_db_prepare_input($HTTP_POST_VARS['fam_subcat_ids']),
	 	...
	 	$findstoreckeckinfo = tep_db_query("select *  from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES . "  where fam_cat_id  = '" .$HTTP_POST_VARS['fam_cat_id']."'");

		  if ($store_check = tep_db_fetch_array($findstoreckeckinfo)) {

			tep_db_perform(TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES, $sql_data_array, 'update', "fam_cat_id = '" .$HTTP_POST_VARS['fam_cat_id'] . "'");
			$fam_prod_id = $HTTP_POST_VARS['fam_cat_id'];
			
		  }else {

		  	 tep_db_perform(TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES, $sql_data_array);
        ...
        tep_redirect(tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES,'fam_prod_id='.$fam_prod_id));
      ...
      case 'update_que_ans': //user wants to modify a news article.
        ...
        if($HTTP_GET_VARS['fam_prod_id']) {
          ...
          tep_db_perform(TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES, $sql_data_array, 'update', "fam_prod_id = '" . tep_db_prepare_input($HTTP_GET_VARS['fam_prod_id']) . "'");
       ...
       // tep_redirect(tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES));
		tep_redirect(tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES,"fam_prod_id=". tep_db_prepare_input($HTTP_GET_VARS['fam_prod_id']))); 
        break;
...
if(document.product_queston_write.fam_subcat_ids.value == ""){
alert("Please enter the value for sub categories ids");
document.product_queston_write.fam_subcat_ids.focus();
return false;
}
...
//echo $login_id;
include DIR_FS_CLASSES . 'Remark.class.php';
$listrs = new Remark('famous_attraction_subcategories');
...
<?php
  ...
  if ($HTTP_GET_VARS['action'] == 'edit_tour_type') { //insert or edit a news item
    ...
    if ( isset($HTTP_GET_VARS['fam_prod_id']) ) { //editing exsiting news item
      ...
      $que_ans_query = tep_db_query("select *  from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES . " where fam_prod_id = '" . $HTTP_GET_VARS['fam_prod_id'] . "'");
...
?>
      ...
      <tr><?php echo tep_draw_form('edit_quesion', FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, isset($HTTP_GET_VARS['fam_prod_id']) ? 'fam_prod_id='.$HTTP_GET_VARS['fam_prod_id'].'&action=update_que_ans' : 'action=insert_stores_deals', 'post', 'enctype="multipart/form-data"'); ?>
		...
		<tr> 
			...
			<td width="25%" class="main"><b>Add Products Ids:</b><br><small>(ex-15,30,45,43)</small> &nbsp;<font color="#FF0000">*</font></td>
	
			<td width="75%" class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '10'); ?><?php echo tep_draw_input_field('fam_subcat_ids', stripslashes($que_ans['fam_subcat_ids'])); ?></td>
      ...
      <tr>
        ...
        <td class="main" align="right">
          ...
          <?php
            ...
            isset($HTTP_GET_VARS['fam_prod_id']) ? $cancel_button = '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES,'fam_prod_id='.$HTTP_GET_VARS['fam_prod_id']). '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>' : $cancel_button = '';
...
if(isset($HTTP_GET_VARS['deleteansid']) && $HTTP_GET_VARS['deleteansid'] != ''){
  tep_db_query("delete from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES_ANSWER . " where ans_id = '" . tep_db_input($HTTP_GET_VARS['deleteansid']) . "'");
}
...
?>
	  ...
	  <tr>
		...
		<!--  view body text start  -->
			...
			<?php 
			echo tep_draw_form('product_question_answer_write', FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'action=process&fam_prod_id='.$fam_prod_id, 'post', 'onSubmit="return checkForm();"');
			?>
                          ...
                          <tr> 
						   ...
						   <td colspan="3">
								  ...
								  <tr> 
									...
									<td class="main"><?php echo '<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, tep_get_all_get_params(array('cPath','replay','page'))) . '">' . tep_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2" class="unnamed1" >
				<?php 
				  ...
				  $question_query_raw = "select * from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES ." where fam_prod_id = '" . (int)$HTTP_GET_VARS['fam_prod_id'] . "'";
				...
				?>
									...
									<tr> 
											...
											<table border="0" width="100%" cellspacing="0" cellpadding="2">
											  ...
											  ?>
												...
												<tr bgcolor="#99D2ED"> 
												  ...
												  <td width="95%" valign="top" class="main"><?php echo tep_break_string(tep_output_string_protected($question['fam_subcat_ids']), 80, '-<br>'); ?></td>
												  <td width="5%" align="right" valign="bottom" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, tep_get_all_get_params(array('page')).'replay=ans','NONSSL',true,true,"qanda") . '">' . tep_image_button('button_reply.gif', 'Reply') . '</a>'; ?></td>
												</tr>
											<!--
										  <tr> 
									  ...
									  <?php 
										$question_query_answer_raw = tep_db_query("select * from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES_ANSWER ." where fam_prod_id = '" . (int)$question['fam_prod_id'] . "' order by date desc");
										  ...
										  <td width="97%"><table border="0" width="100%" cellspacing="0" cellpadding="2">
											  ...
											  ?>
												...
												<tr bgcolor="#DCF4FE"> 
												  ...
												  <td width="5%" align="right" valign="bottom" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, "fam_prod_id=".$question['fam_prod_id']."&action=view_question&deleteansid=".$question_ans['ans_id']."") . '">' . tep_image_button('button_delete.gif', 'Reply') . '</a>'; ?></td>
												</tr>
											<!--
										  <tr> 
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="2">
												  ...
												  <tr> 
													...
													<td class="main"><?php echo '<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, tep_get_all_get_params(array('dealscat','replay','page','action','deleteansid'))) . '">' . tep_image_button('button_back.gif', 'Back') . '</a>'; ?></td>
          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td colspan="2" class="pageHeading">Add Tour Category Type</td>
				...
				<?php 
				echo tep_draw_form('product_queston_write', FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'action=addtourproccess', 'post', 'onSubmit="return checkForm1();"');
				?>
				<table border="0" width="100%" cellspacing="0" cellpadding="0">
											...
											<tr> 
											  ...
											  <td></br><table border="0" width="100%" cellspacing="2" cellpadding="2" class="unnamed1" >
												...
												<tr> 
													...
													<td width="75%" class="main"><?php echo tep_draw_input_field('fam_subcat_ids'); ?></td>
			...
			<tr> 
						<td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
												  ...
												  <tr> 
													...
													<td class="main"><?php echo '<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, tep_get_all_get_params(array('cPath','replay','page','action'))) . '">' . tep_image_button('button_back.gif', 'Back') . '</a>'; ?></td>
            ...
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
			  ...
			  <td class="dataTableHeadingContent">#ID</td>
                ...
                <td class="dataTableHeadingContent">Top Category</td>
				 ...
				 <td class="dataTableHeadingContent">Show Sub Categories</td>
...
*/
  ...
  //$question_query_raw = "select count(*) as count,q.fam_prod_id,q.products_id,q.question,q.date from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES_ANSWER . " as qa," . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES . " as q where q.fam_prod_id = qa.fam_prod_id  group by qa.fam_prod_id order by count";
 	
	
	$question_query_raw = "select *  from " . TABLE_FAMOUS_ATTRACTION_SUBCATEGORIES ." order by $order";
    ...
    while ($question = tep_db_fetch_array($question_query)) {
	 ...
	 $HTTP_GET_VARS['fam_prod_id'] = $question['fam_prod_id'];  
      ...
      if ( (is_array($selected_item)) && ($question['fam_prod_id'] == $selected_item['fam_prod_id']) ) {
        ...
        echo '<tr class="dataTableRowSelected" onmouseover="this.style.cursor=\'hand\'" onclick="document.location.href=\'' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'fam_prod_id=' . $question['fam_prod_id']) . '\'">' . "\n";

      } else {

        echo '<tr class="dataTableRow" onmouseover="this.className=\'dataTableRowOver\';this.style.cursor=\'hand\'" onmouseout="this.className=\'dataTableRow\'" onclick="document.location.href=\'' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'fam_prod_id=' . $question['fam_prod_id']) . '\'">' . "\n";
...
?>
               ...
               <td class="dataTableContent"><?php echo tep_get_categories_name($question['fam_cat_id']); ?>
				 ...
				 <td class="dataTableContent"><?php echo $question['fam_subcat_ids']; ?>
			   </td>
                ...
                <td class="dataTableContent" align="right"><?php if ($question['fam_prod_id'] == $HTTP_GET_VARS['fam_prod_id']) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.gif', ''); } else { echo '<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'fam_prod_id=' . $question['fam_prod_id'].'&'.tep_get_all_get_params(array('info', 'x', 'y', 'action','dealscat' , 'fam_prod_id'))) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
...
<?php
    ...
    switch ($HTTP_GET_VARS['action']) {
      ...
      case 'delete_tour_type': //generate box for confirming a news article deletion
        ...
        $contents = array('form'    => tep_draw_form('news', FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, '&action=delete_tour_type_confirm') . tep_draw_hidden_field('fam_prod_id', $HTTP_GET_VARS['fam_prod_id']));

       // $contents[] = array('text'  => TEXT_DELETE_ITEM_INTRO);

        $contents[] = array('text'  => '<br><b>' . $selected_item['fam_subcat_ids'] . '</b>');

        

        $contents[] = array('align' => 'center',

                            'text'  => '<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'fam_prod_id=' . $selected_item['fam_prod_id']).'">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
        ...
        if ($rows > 0) {
          ...
          if (is_array($selected_item)) { //an item is selected, so make the side box
            ...
            $contents[] = array('align' => 'center', 
                                ...
                                'text' => '<a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'action=addtourtype') . '">' . tep_image_button('button_new.gif', IMAGE_ADD) . '</a> <a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'fam_prod_id=' . $selected_item['fam_prod_id'] . '&action=edit_tour_type') . '">' . tep_image_button('button_edit.gif', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'fam_prod_id=' . $selected_item['fam_prod_id'] . '&action=delete_tour_type') . '">' . tep_image_button('button_delete.gif', IMAGE_DELETE) . '</a></br>');
          ...
          $contents[] = array('text' => sprintf(TEXT_NO_CHILD_CATEGORIES_OR_PRODUCTS, $parent_categories_name) .'<br><a href="' . tep_href_link(FILENAME_FAMOUS_ATTRACTION_SUBCATEGORIES, 'action=addtourtype') . '">' . tep_image_button('button_new.gif', IMAGE_ADD) . '</a>');
