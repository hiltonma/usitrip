...
<!-- body //-->
<?php echo tep_draw_form('etickets', 'edit_orders.php', tep_get_all_get_params(array('action')) . 'action=add_product', 'post', 'onsubmit="return validation_guest();"');
?>
			...
			<table width="100%" cellpadding="3" cellspacing="0">
				...
				for($noofguest=1;$noofguest<=$total_no_guest_tour;$noofguest++)
				{
					if($noofguest != '')
					{
						...
						<td width="40%" class="dataTableContent">&nbsp;<input type="text" name="<?php echo 'guest'.$noofguest; ?>" value="" /></td>
						<?php 
						if(($noofguest%2)==0)
						echo '</tr>';
...
//--></script>
						<table border="0" width="100%" cellspacing="0" cellpadding="2">
						  ...
						  <tr>
								...
								<script type="text/javascript">dateAvailable1.writeControl(); dateAvailable1.dateFormat="yyyy-MM-dd";</script></td>
							  </tr>
						  <tr>
	  ...
	  <input type="hidden" name="early_hotel_checkout_date" value="<?php echo $_POST['early_hotel_checkout_date'];?>"/>
