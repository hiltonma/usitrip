...
$check_room_option_product_query = tep_db_query("select  display_room_option from " . TABLE_PRODUCTS . " where products_id = '" . (int)$ppproducts_id . "'");
$check_room_option_product = tep_db_fetch_array($check_room_option_product_query);

switch($check_room_option_product['display_room_option']) {
...
$tour_agency_opr_currency = tep_get_tour_agency_operate_currency($ppproducts_id);
...
if(isset($ppproducts_id) && $ppproducts_id>0  && $product_num_row>0)
{
	...
	{
		if(is_array($v) && $sec_cnt_db<=$totalsections)
		{
		...
		?>
		 ...
		 <tr>
		  ...
		  <?php
			...
			//edit and then change sections - that code portion
		  ?>
		  <tr>
			 <td class="main" nowrap>Regular Price of This Section: </td>
             <td class="main">					 
			 	<table border="0" cellpadding="2" cellspacing="0" bgcolor="FFFFFF" width="75%">
					<tr>
					...
					<tr class="dataTableRow">
						...
						if($access_full_edit == 'true') { 
							echo '<br />CP &nbsp;' . tep_draw_input_field('products_single_pu_cost'.$nn, $row_edit_standard_prices['products_single_pu_cost'], 'size="7"'.$price_input_readonly); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.products_single_pu_cost<?php echo $nn; ?>, document.new_product.products_single_pu<?php echo $nn; ?>);"  type=button value="Ëãµ×¼Û(o)" <?= $price_button;?>>
						<?php 
						} else {
						...
						<td class="dataTableContent" width="15%"><?php echo $display_tour_agency_opr_currency_note . 'RP &nbsp;' . tep_draw_input_field('products_double'.$nn, $row_edit_standard_prices['products_double'], 'size="7"'.$price_input_readonly);
						if($access_full_edit == 'true') { 
							echo '<br />CP &nbsp;' . tep_draw_input_field('products_double_cost'.$nn, $row_edit_standard_prices['products_double_cost'], 'size="7"'.$price_input_readonly); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.products_double_cost<?php echo $nn; ?>, document.new_product.products_double<?php echo $nn; ?>);"  type=button value="Ëãµ×¼Û(o)" <?= $price_button;?>>
						<?php 
						}else{ 
						...
						<td class="dataTableContent" width="15%"><?php echo $display_tour_agency_opr_currency_note . 'RP &nbsp;' . tep_draw_input_field('products_triple'.$nn, $row_edit_standard_prices['products_triple'], 'size="7"'.$price_input_readonly);
						if($access_full_edit == 'true') { 
							echo '<br />CP &nbsp;' . tep_draw_input_field('products_triple_cost'.$nn, $row_edit_standard_prices['products_triple_cost'], 'size="7"'.$price_input_readonly); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.products_triple_cost<?php echo $nn; ?>, document.new_product.products_triple<?php echo $nn; ?>);"  type=button value="Ëãµ×¼Û(o)" <?= $price_button;?>>
						<?php 
						}else{ 
						...
						<td class="dataTableContent" width="15%"><?php echo $display_tour_agency_opr_currency_note . 'RP &nbsp;' . tep_draw_input_field('products_quadr'.$nn, $row_edit_standard_prices['products_quadr'], 'size="7"'.$price_input_readonly);
						if($access_full_edit == 'true') { 
							echo '<br />CP &nbsp;' . tep_draw_input_field('products_quadr_cost'.$nn, $row_edit_standard_prices['products_quadr_cost'], 'size="7"'.$price_input_readonly); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.products_quadr_cost<?php echo $nn; ?>, document.new_product.products_quadr<?php echo $nn; ?>);"  type=button value="Ëãµ×¼Û(o)" <?= $price_button;?>>
						<?php 
						}else{ 
						...
						if($access_full_edit == 'true') { 
							echo '<br />CP &nbsp;' . tep_draw_input_field('products_kids_cost'.$nn, $row_edit_standard_prices['products_kids_cost'], 'size="7"'.$price_input_readonly); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.products_kids_cost<?php echo $nn; ?>, document.new_product.products_kids<?php echo $nn; ?>);"  type=button value="Ëãµ×¼Û(o)" <?= $price_button;?>>
						<?php 
						} else {
...
$weekday_kids_price_cost_result[$nn.$startdate['products_start_day']] = $startdate['spe_kids_cost'];
					  ...
					  <table border="0" cellpadding="2" cellspacing="0" bgcolor="FFFFFF">
						  ...
						  ?>						 
						   <tr class="dataTableRow">
							...
							<td class="dataTableContent"  align="center"><?php echo tep_draw_input_field('weekday_prefix'.$nn.$j, $weekday_prefix_result[$nn.$j], 'size="2" onKeyUp="return weekday_prefix_check_irregular('.$nn.$j.');"'); ?></td>
							
						
							<?php if($weekday_single_price_result[$nn.$j]>0 || $weekday_single_price_pu_result[$nn.$j]>0 || $weekday_double_price_result[$nn.$j]>0 || $weekday_triple_price_result[$nn.$j]>0 || $weekday_quadruple_price_result[$nn.$j]>0 || $weekday_kids_price_result[$nn.$j]>0) 
							{ 
								$check_spe_price_regular=true;
							}
							else { $check_spe_price_regular=false;}?>
							
							<?php  if($access_full_edit == 'true') {?>
							 <td colspan="6"  class="dataTableContent" align="left" valign="top" style=" white-space:nowrap;">
							 <table  border="0" cellspacing="0" cellpadding="2" width="100%">
								  <tr>

									<td class="dataTableContent"  align="left" style=" white-space:nowrap;" >
							RP <?php echo $display_tour_agency_opr_currency_note; ?><?php 
							...
							if($access_full_edit == 'true') { 
							echo  '<br>CP ' .$display_tour_agency_opr_currency_note . tep_draw_input_field('weekday_price_cost'.$nn.$j, $weekday_price_result_cost[$nn.$j], 'size="7"'.$price_input_readonly); ?><br>&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_price_cost<?php echo $nn.$j;?>, document.new_product.weekday_price<?php echo $nn.$j;?>);"  type=button value="Ëãµ×¼Û(o)" <?= $price_button;?>>
							<?php } ?>
							</td>
 ...
 <?php if($weekday_single_price_result[$nn.$j]>0 || $weekday_single_pu_price_result[$nn.$j]>0 || $weekday_double_price_result[$nn.$j]>0 || $weekday_triple_price_result[$nn.$j]>0 || $weekday_quadruple_price_result[$nn.$j]>0 || $weekday_kids_price_result[$nn.$j]>0) { $display_val = 'visible';}else { $display_val='none';}?>
							  ...
							  <div id="regular_extra_price_<?php echo $nn.$j;?>" style="display:<?php echo $display_val?>; float:left">
								...
								<table width="100%"   border="0" cellspacing="5" cellpadding="5">
								  <tr>
									<td width="10%"><?php echo tep_draw_input_field('weekday_single_price'.$nn.$j, $weekday_single_price_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('weekday_single_price_cost'.$nn.$j, $weekday_single_price_cost_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_single_price_cost'.$nn.$j.', weekday_single_price'.$nn.$j.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
							 		</td>
									<td width="10%"><?php echo tep_draw_input_field('weekday_single_pu_price'.$nn.$j, $weekday_single_price_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('weekday_single_pu_price_cost'.$nn.$j, $weekday_single_pu_price_cost_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_single_pu_price_cost'.$nn.$j.', weekday_single_pu_price'.$nn.$j.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
							 		</td>
									
									<td width="10%"> <?php echo tep_draw_input_field('weekday_double_price'.$nn.$j, $weekday_double_price_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('weekday_double_price_cost'.$nn.$j, $weekday_double_price_cost_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_double_price_cost'.$nn.$j.', weekday_double_price'.$nn.$j.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
						   			</td>
									<td width="10%"><?php echo tep_draw_input_field('weekday_triple_price'.$nn.$j, $weekday_triple_price_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('weekday_triple_price_cost'.$nn.$j, $weekday_triple_price_cost_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_triple_price_cost'.$nn.$j.', weekday_triple_price'.$nn.$j.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
									 </td>
									<td width="10%"><?php echo tep_draw_input_field('weekday_quadruple_price'.$nn.$j, $weekday_quadruple_price_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('weekday_quadruple_price_cost'.$nn.$j, $weekday_quadruple_price_cost_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_quadruple_price_cost'.$nn.$j.', weekday_quadruple_price'.$nn.$j.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
							 		</td>
									<td width="10%"> <?php echo tep_draw_input_field('weekday_kids_price'.$nn.$j, $weekday_kids_price_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('weekday_kids_price_cost'.$nn.$j, $weekday_kids_price_cost_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_kids_price_cost'.$nn.$j.', weekday_kids_price'.$nn.$j.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
									</td>
								  </tr>
								</table>
								</div>
							   ...
							   <?php }else{  //echo $pInfo->products_is_regular_tour;?>
							<td colspan="6" width="50%" class="dataTableContent" align="left">
							<?php echo tep_draw_input_field('weekday_price'.$nn.$j,$weekday_price_result[$nn.$j],'size="7" '.($check_spe_price_regular?'disabled="disabled"':'').''); ?>
							 ...
							 <?php if($weekday_single_price_result[$nn.$j]>0 || $weekday_single_pu_price_result[$nn.$j]>0 || $weekday_double_price_result[$nn.$j]>0 || $weekday_triple_price_result[$nn.$j]>0 || $weekday_quadruple_price_result[$nn.$j]>0 || $weekday_kids_price_result[$nn.$j]>0) { $display_val = 'visible';}else { $display_val='none';}?> 
							  ...
							  &nbsp;<?php echo tep_draw_input_field('weekday_single_price'.$nn.$j, $weekday_single_price_result[$nn.$j], 'size="7"'); ?>
							  &nbsp;<?php echo tep_draw_input_field('weekday_single_pu_price'.$nn.$j, $weekday_single_pu_price_result[$nn.$j], 'size="7"'); ?>
							  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_double_price'.$nn.$j, $weekday_double_price_result[$nn.$j], 'size="7"'); ?>
						    &nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_triple_price'.$nn.$j, $weekday_triple_price_result[$nn.$j], 'size="7"'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_quadruple_price'.$nn.$j, $weekday_quadruple_price_result[$nn.$j], 'size="7"'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_kids_price'.$nn.$j, $weekday_kids_price_result[$nn.$j], 'size="7"'); ?>
							</div>
							</td>
							 <?php } ?>

							<td class="dataTableContent" width="70" align="center"><?php echo tep_draw_input_field('weekday_sort_order'.$nn.$j, $weekday_sort_order_result[$nn.$j], 'size="7" onKeyUp="return weekday_sort_order_check_irregular('.$nn.$j.');"'); ?></td>
...
{
?>
<a href="javascript:void(0)" onclick="javascript:show_hide_regular_div(<?php echo $nn.$j;?>, <?php echo ($display_room_yes==''?0:1)?>)">Sepecial Price</a>
		 ...
		 <tr>
		  ...
		  <?php 
				...
				$edit_irregular_data ='';
						...
						<td class="dataTableContent" align="center" width="10%" ><input name="avaliable_day_prefix_'.$nn.'_'.$i.'" size="2" value="'.$available['prefix'].'" type="text"></td>
						<td class="dataTableContent" align="left" width="16%"  style=" white-space:nowrap;">RP '.$display_tour_agency_opr_currency_note.'<input name="avaliable_day_price_'.$nn.'_'.$i.'" '.($check_spe_price?'disabled="disabled"':'').$price_input_readonly.' size="7" value="'.$available['extra_charge'].'" type="text"><br>CP '.$display_tour_agency_opr_currency_note.'<input name="avaliable_day_price_cost_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['extra_charge_cost'].'" type="text"><br>&nbsp;&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_day_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_day_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></td>
						<td class="dataTableContent"  align="left" width="10%">';
						
						if($check_spe_price){
						 $edit_irregular_data .= '<input name="avaliable_single_price_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_single'].'" type="text"><br><input name="avaliable_single_price_cost_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_single_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_single_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_single_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>';
						}else{
						 $edit_irregular_data .= '<div id="show_sub_div_s_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_single_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' type="text"><br><input name="avaliable_single_price_cost_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_single_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_single_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_single_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></div><div id="hide_sub_div_s_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'</div>';
						}
						
						$edit_irregular_data .= '</td>						
						<td class="dataTableContent"  align="left" width="10%">';
						if($check_spe_price){
						 $edit_irregular_data .= '<input name="avaliable_single_pu_price_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_single_pu'].'" type="text"><br><input name="avaliable_single_pu_price_cost_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_single_pu_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_single_pu_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_single_pu_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>';
						}else{
						 $edit_irregular_data .= '<div id="show_sub_div_sp_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_single_pu_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' type="text"><br><input name="avaliable_single_pu_price_cost_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_single_pu_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_single_pu_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_single_pu_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></div><div id="hide_sub_div_sp_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'</div>';
						}
						
						$edit_irregular_data .= '</td>						
						<td class="dataTableContent"  align="left" width="10%">';
						if($check_spe_price){
						 $edit_irregular_data .= '<input name="avaliable_double_price_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_double'].'" type="text"><br><input name="avaliable_double_price_cost_'.$nn.'_'.$i.'" '.$price_input_readonly.' size="7" value="'.$available['spe_double_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_double_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_double_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>';
						 }else{
						 $edit_irregular_data .= '<div id="show_sub_div_d_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_double_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' type="text"><br><input name="avaliable_double_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_double_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_double_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_double_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></div><div id="hide_sub_div_d_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'</div>';
						 }
						 $edit_irregular_data .= '</td>						
						<td class="dataTableContent" align="left" width="10%">';
						if($check_spe_price){
						 $edit_irregular_data .= '<input name="avaliable_triple_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' value="'.$available['spe_triple'].'" type="text"><br><input name="avaliable_triple_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_triple_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_triple_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_triple_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>';
						 }else{
						 $edit_irregular_data .= '<div id="show_sub_div_t_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_triple_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' type="text"><br><input name="avaliable_triple_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_triple_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_triple_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_triple_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></div><div id="hide_sub_div_t_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'</div>';
						 }
						 $edit_irregular_data .= '</td>						
						<td class="dataTableContent" align="left" width="10%">';
						if($check_spe_price){
						 $edit_irregular_data .= '<input name="avaliable_quadruple_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' value="'.$available['spe_quadruple'].'" type="text"><br><input name="avaliable_quadruple_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_quadruple_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_quadruple_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_quadruple_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>';
						 }else{
						 $edit_irregular_data .= '<div id="show_sub_div_q_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_quadruple_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' type="text"><br><input name="avaliable_quadruple_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_quadruple_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_quadruple_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_quadruple_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></div><div id="hide_sub_div_q_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'</div>';
						  }
						 $edit_irregular_data .= '</td>						
						<td class="dataTableContent" align="left" width="10%">';
						 if($check_spe_price){
						 $edit_irregular_data .= '<input name="avaliable_kids_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' value="'.$available['spe_kids'].'" type="text"><br><input name="avaliable_kids_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_kids_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_kids_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_kids_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>';
						 }else{
						 $edit_irregular_data .= '<div id="show_sub_div_k_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_kids_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' type="text"><br><input name="avaliable_kids_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_kids_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_kids_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_kids_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></div><div id="hide_sub_div_k_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'</div>';
						 }
						 $edit_irregular_data .= '</td>						
						<td class="dataTableContent" align="center" width=10%"><input name="avaliable_day_sort_order_'.$nn.'_'.$i.'" size="7" value="'.$available['sort_order'].'" type="text"></td><td align="center" width="10%"><input src="includes/languages/schinese/images/buttons/button_delete.gif" name="delete_'.$nn.'_'.$i.'" '.$price_button.' onClick="return clearrow_irregular('.$nn.','.$i.');" type="image"></td><td></td><td colspan=2 class="dataTableContent" width="10%"> '.($check_spe_price?'<a href="javascript:void(0)" onclick="javascript:delete_spe_price('.$nn.','.$i.');">Delete spe. Price</a>':'<a href="javascript:void(0)" onclick="javascript:enter_spec_price('.$nn.','.$i.')">Sepecial Price</a>').' </td>
						</tr></tbody></table>';
							
						}else{
							$edit_irregular_data .= '<table border=0 id="table_id_irregular'.$nn.'_'.$i.'" cellpadding="2" cellspacing="2" width="100%"><tbody><tr class="'.(floor($i/2) == ($i/2) ? 'attributes-even' : 'attributes-odd').'"><td class="dataTableContent" width="15%">'.$i.'. <input name="avaliable_day_date_'.$nn.'_'.$i.'" size="12" value="'.$available['available_date'].'" type="text"></td><td class="dataTableContent" align="center" width="10%" ><input name="avaliable_day_prefix_'.$nn.'_'.$i.'" size="2" value="'.$available['prefix'].'" type="text"></td><td class="dataTableContent" align="left" width="10%"><input name="avaliable_day_price_'.$nn.'_'.$i.'" size="7" '.($check_spe_price?'disabled="disabled"':'').' value="'.$available['extra_charge'].'" type="text"></td><td class="dataTableContent"  align="left" width="10%">'.($check_spe_price ?'<input name="avaliable_single_price_'.$nn.'_'.$i.'" size="7" value="'.$available['spe_single'].'" type="text">':'<div id="show_sub_div_s_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_single_price_'.$nn.'_'.$i.'" size="7"  type="text"></div><div id="hide_sub_div_s_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'&nbsp;').'</div></td><td class="dataTableContent"  align="left" width="10%">'.($check_spe_price ?'<input name="avaliable_single_pu_price_'.$nn.'_'.$i.'" size="7" value="'.$available['spe_single_pu'].'" type="text">':'<div id="show_sub_div_sp_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_single_pu_price_'.$nn.'_'.$i.'" size="7"  type="text"></div><div id="hide_sub_div_sp_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'&nbsp;').'</div></td><td class="dataTableContent"  align="left" width="10%">'.($check_spe_price ?'<input name="avaliable_double_price_'.$nn.'_'.$i.'" size="7" value="'.$available['spe_double'].'" type="text">':'<div id="show_sub_div_d_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_double_price_'.$nn.'_'.$i.'" size="7"  type="text"></div><div id="hide_sub_div_d_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'&nbsp;').'</div></td><td class="dataTableContent" align="left" width="10%">'.($check_spe_price ?'<input name="avaliable_triple_price_'.$nn.'_'.$i.'" size="7" value="'.$available['spe_triple'].'" type="text">':'<div id="show_sub_div_t_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_triple_price_'.$nn.'_'.$i.'" size="7"  type="text"></div><div id="hide_sub_div_t_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'&nbsp;').'</div></td><td class="dataTableContent" align="left" width="10%">'.($check_spe_price ?'<input name="avaliable_quadruple_price_'.$nn.'_'.$i.'" size="7" value="'.$available['spe_quadruple'].'" type="text">':'<div id="show_sub_div_q_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_quadruple_price_'.$nn.'_'.$i.'" size="7"  type="text"></div><div id="hide_sub_div_q_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'&nbsp;').'</div></td><td class="dataTableContent" align="left" width="10%">'.($check_spe_price ?'<input name="avaliable_kids_price_'.$nn.'_'.$i.'" size="7" value="'.$available['spe_kids'].'" type="text">':'<div id="show_sub_div_k_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_kids_price_'.$nn.'_'.$i.'" size="7"  type="text"></div><div id="hide_sub_div_k_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'&nbsp;').'</div></td><td class="dataTableContent" align="center" width=10%"><input name="avaliable_day_sort_order_'.$nn.'_'.$i.'" size="7" value="'.$available['sort_order'].'" type="text"></td><td align="center" width="10%"><input src="includes/languages/schinese/images/buttons/button_delete.gif" name="delete_'.$nn.'_'.$i.'" '.$price_button.' onClick="return clearrow_irregular('.$nn.','.$i.');" type="image"></td><td></td><td colspan=2 class="dataTableContent" width="10%"> '.($check_spe_price?'<a href="javascript:void(0)" onclick="javascript:delete_spe_price('.$nn.','.$i.');">Delete spe. Price</a>':'<a href="javascript:void(0)" onclick="javascript:enter_spec_price('.$nn.','.$i.')">Sepecial Price</a>').' </td></tr></tbody></table>';
						}	
						...
						?>
						 ...
						 <tr>
						  ...
						  <tr class="dataTableRow">
							   ...
							   <div id="extra_price_<?php echo $nn;?>" style="display:none; float:left">
								<table width="100%"   border="0" cellspacing="5" cellpadding="5">
								  <tr>
									...
									<td width="10%"> <?php echo tep_draw_input_field('avaliable_double_price'.$nn, '', 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('avaliable_double_price_cost'.$nn, '', 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_double_price_cost'.$nn.', avaliable_double_price'.$nn.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
						   			</td>
									<td width="10%"><?php echo tep_draw_input_field('avaliable_triple_price'.$nn, '', 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('avaliable_triple_price_cost'.$nn, '', 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_triple_price_cost'.$nn.', avaliable_triple_price'.$nn.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
									 </td>
									<td width="10%"><?php echo tep_draw_input_field('avaliable_quadruple_price'.$nn, '', 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('avaliable_quadruple_price_cost'.$nn, '', 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_quadruple_price_cost'.$nn.', avaliable_quadruple_price'.$nn.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
							 		</td>
									<td width="10%"> <?php echo tep_draw_input_field('avaliable_kids_price'.$nn, '', 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('avaliable_kids_price_cost'.$nn, '', 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_kids_price_cost'.$nn.', avaliable_kids_price'.$nn.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
									</td>
								  </tr>
								</table>
								</div>
							...
							<?php }else{ ?>
							<td colspan="7" width="50%" class="dataTableContent" align="left"><?php echo tep_draw_input_field('avaliable_day_price'.$nn, '', 'size="7"'); ?>
						    ...
						    &nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('avaliable_triple_price'.$nn, '', 'size="7"'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('avaliable_quadruple_price'.$nn, '', 'size="7"'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('avaliable_kids_price'.$nn, '', 'size="7"'); ?></div>
							</td>
							<?php } ?> 
							<td class="dataTableContent" width="10%" align="center"><?php echo tep_draw_input_field('avaliable_day_sort_order'.$nn, '', 'size="7"'); ?></td>
							<td class="dataTableContent" width="10%" align="center">
							<input type="image" src="includes/languages/schinese/images/buttons/button_insert.gif" <?= $price_button;?> onClick="return add_irregular(<?php echo $nn;?>)">
							<?php //echo tep_image_submit('button_insert.gif', '', 'onClick="return add_irregular('.$nn.')"'); ?> 
							
							</td>
							<td class="dataTableContent" width="10%" align="center"> <a href="javascript:void(0)" onclick="javascript:show_hide_div(<?php echo $nn;?>)">Sepecial Price</a> </td>
                        </tr>
	...
	?>
		 ...
		 <table width="100%" border="0" cellspacing="1" cellpadding="1">
		   <tr>
			...
			//for new added section use currect year and next year by default
			if($operate_start_date_array[2] == ''){
			$operate_start_date_array[2] = date("Y");
			}
			echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' .tep_draw_pull_down_menu('operate_start_date_month'.$nn, $months_operate_array, $operate_start_date_array[0],'').'&nbsp;'.tep_draw_pull_down_menu('operate_start_date_day'.$nn, $days_operate_array, $operate_start_date_array[1],'').'&nbsp;'.tep_draw_pull_down_menu('operate_start_date_year'.$nn, $operate_years_array, $operate_start_date_array[2],''); ?></td>
          </tr>
		 <tr>
			...
			//for new added section use currect year and next year by default
			if($operate_end_date_array[2] == ''){
			$operate_end_date_array[2] = date("Y")+1;
			}
			echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' .tep_draw_pull_down_menu('operate_end_date_month'.$nn, $months_operate_array, $operate_end_date_array[0],'').'&nbsp;'.tep_draw_pull_down_menu('operate_end_date_day'.$nn, $days_operate_array, $operate_end_date_array[1],'').'&nbsp;'.tep_draw_pull_down_menu('operate_end_date_year'.$nn, $operate_years_array, $operate_end_date_array[2],'');?></td>
         </tr>
		   <tr>
					  ...
					  <table border="0" cellpadding="2" cellspacing="0" bgcolor="FFFFFF">
						  ...
						  ?>						 
						   <tr class="dataTableRow">
							...
							<?php if($weekday_single_price_result[$nn.$j]>0 || $weekday_single_pu_price_result[$nn.$j]>0 || $weekday_double_price_result[$nn.$j]>0 || $weekday_triple_price_result[$nn.$j]>0 || $weekday_quadruple_price_result[$nn.$j]>0 || $weekday_kids_price_result[$nn.$j]>0) 
							{ 
								$check_spe_price_regular=true;
							}
							else { $check_spe_price_regular=false;}?>
 ...
 <?php if($weekday_single_price_result[$nn.$j]>0 || $weekday_single_pu_price_result[$nn.$j]>0 || $weekday_double_price_result[$nn.$j]>0 || $weekday_triple_price_result[$nn.$j]>0 || $weekday_quadruple_price_result[$nn.$j]>0 || $weekday_kids_price_result[$nn.$j]>0) { $display_val = 'visible';}else { $display_val='none';}?>
							  ...
							  <div id="regular_extra_price_<?php echo $nn.$j;?>" style="display:<?php echo $display_val?>; float:left">
								...
								<table width="100%"   border="0" cellspacing="5" cellpadding="5">
								  <tr>
									...
									<td width="10%"><?php echo tep_draw_input_field('weekday_single_pu_price'.$nn.$j, $weekday_single_pu_price_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br>'.tep_draw_input_field('weekday_single_pu_price_cost'.$nn.$j, $weekday_single_pu_price_cost_result[$nn.$j], 'size="7"'.$price_input_readonly).'<br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.weekday_single_pu_price_cost'.$nn.$j.', weekday_single_pu_price'.$nn.$j.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>'; ?>
							 		</td>
							...
							<?php echo tep_draw_input_field('weekday_price'.$nn.$j,$weekday_price_result[$nn.$j],'size="7" '.($check_spe_price_regular?'disabled="disabled"':'').''); ?>
							 ...
							 <?php if($weekday_single_price_result[$nn.$j]>0 || $weekday_single_pu_price_result[$nn.$j]>0 || $weekday_double_price_result[$nn.$j]>0 || $weekday_triple_price_result[$nn.$j]>0 || $weekday_quadruple_price_result[$nn.$j]>0 || $weekday_kids_price_result[$nn.$j]>0) { $display_val = 'visible';}else { $display_val='none';}?> 
							  ...
							  &nbsp;<?php echo tep_draw_input_field('weekday_single_price'.$nn.$j, $weekday_single_price_result[$nn.$j], 'size="7"'); ?>&nbsp;<?php echo tep_draw_input_field('weekday_single_pu_price'.$nn.$j, $weekday_single_pu_price_result[$nn.$j], 'size="7"'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_double_price'.$nn.$j, $weekday_double_price_result[$nn.$j], 'size="7"'); ?>
						    &nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_triple_price'.$nn.$j, $weekday_triple_price_result[$nn.$j], 'size="7"'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_quadruple_price'.$nn.$j, $weekday_quadruple_price_result[$nn.$j], 'size="7"'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo tep_draw_input_field('weekday_kids_price'.$nn.$j, $weekday_kids_price_result[$nn.$j], 'size="7"'); ?>
							</div>
							</td>
							 <?php } ?>
...
?>
		 ...
		 <tr>
		  ...
		  <?php $i =1;
		 		if($pInfo->products_is_regular_tour.$nn != "" && $pInfo->products_is_regular_tour.$nn == '0')
				{
		...
		if($available['spe_double']>0 || $available['spe_triple']>0 || $available['spe_quadruple']>0 || $available['spe_kids']>0)
						...
						<td class="dataTableContent" width="15%"  style=" white-space:nowrap;">'.$i.'. <input name="avaliable_day_date_'.$nn.'_'.$i.'" size="12" value="'.$available['available_date'].'" type="text"></td>
						<td class="dataTableContent" align="center" width="10%" ><input name="avaliable_day_prefix_'.$nn.'_'.$i.'" size="2" value="'.$available['prefix'].'" type="text"></td>
						<td class="dataTableContent" align="left" width="16%"  style=" white-space:nowrap;">RP '.$display_tour_agency_opr_currency_note.'<input name="avaliable_day_price_'.$nn.'_'.$i.'" '.($check_spe_price?'disabled="disabled"':'').' size="7" '.$price_input_readonly.' value="'.$available['extra_charge'].'" type="text"><br>CP '.$display_tour_agency_opr_currency_note.'<input name="avaliable_day_price_cost'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['extra_charge_cost'].'" type="text"><br>&nbsp;&nbsp;&nbsp;<input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_day_price_cost'.$nn.'_'.$i.', document.new_product.avaliable_day_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></td>
						<td class="dataTableContent"  align="left" width="10%">';
						if($check_spe_price){
						...
						<td class="dataTableContent"  align="left" width="10%">';
						if($check_spe_price){
						 $edit_irregular_data .= '<input name="avaliable_single_pu_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' value="'.$available['spe_single_pu'].'" type="text"><br><input name="avaliable_single_pu_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_single_pu_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_single_pu_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_single_pu_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'>';
						}else{
						 $edit_irregular_data .= '<div id="show_sub_div_sp_'.$nn.'_'.$i.'" style="display:none" ><input name="avaliable_single_pu_price_'.$nn.'_'.$i.'" size="7" '.$price_input_readonly.' type="text"><br><input name="avaliable_single_pu_price_cost_'.$nn.'_'.$i.'"  size="7" '.$price_input_readonly.' value="'.$available['spe_single_pu_cost'].'" type="text"><br><input onClick="calculate_retail_price(document.new_product.products_margin,  document.new_product.avaliable_single_pu_price_cost_'.$nn.'_'.$i.', document.new_product.avaliable_single_pu_price_'.$nn.'_'.$i.');"  type=button value="Ëãµ×¼Û(o)" '. $price_button.'></div><div id="hide_sub_div_sp_'.$nn.'_'.$i.'" style="display:block" >'.tep_draw_separator("pixel_trans.gif", "54", "15").'</div>';
						}
						$edit_irregular_data .= '</td>						
						<td class="dataTableContent"  align="left" width="10%">';
						if($check_spe_price){
						...
						?>
						 <tr>
						   ...
						   <tr class="dataTableRow">
							...
							<?php //echo tep_image_submit('button_insert.gif', '', 'onClick="return add_irregular('.$nn.')"'); ?> </td>
							<td class="dataTableContent" width="10%" align="center"> <a href="javascript:void(0)" onclick="javascript:show_hide_div(<?php echo $nn;?>)">Sepecial Price</a> </td>
                        </tr>
