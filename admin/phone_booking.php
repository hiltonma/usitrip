 ...
 // Calculate Tax and Sub-Totals
			...
			*/
			...
			if($addon_new_customer_txt == 1){
				$email_order .= "\n\n".'You can access your account with the following password. Once you access your account, please change your password!'."\n\n".'Website : <a href="'.tep_catalog_href_link(FILENAME_LOGIN, '', 'SSL').'">'.tep_catalog_href_link(FILENAME_LOGIN, '', 'SSL').'</a>'."\n\n".'Username: '.$email_address."\n".'Password: '.$password."\n\n".'Note: By booking over the phone you have agreed to usitrip\'s <a href="http://www.usitrip.com/customer-agreement.php">Customer Agreement</a> and <a href="http://www.usitrip.com/cancellation-and-refund-policy.php">Standard Amendment, Cancellation and Refund Policy</a>. Terms of the preceding policies apply upon completion of your phone booking. You have been advised by usitrip that you have the option to purchase <a href="http://www.usitrip.com/tour_america_need.php">Travel Insurance</a> to protect yourself and your trip.'."\n\n".'Supporting documentation and/or related details are needed from you. '."\n\n".'To review details of supporting documentation requirement and how to send documents to us, please go to'."\n".'<a href="http://www.usitrip.com/acknowledgement_of_card_billing.php">http://www.usitrip.com/acknowledgement_of_card_billing.php</a>'."\n\n";
			}
