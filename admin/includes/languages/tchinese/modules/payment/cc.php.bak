...
*/
  ...
  define('MODULE_PAYMENT_CC_TEXT_DESCRIPTION', '信用卡測試：<br><br>CC#: 4111111111111111<br>到期日： Any');
  define('MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_TYPE', '卡別：');
  ...
  define('MODULE_PAYMENT_CC_TEXT_JS_CC_OWNER', '* 持卡人姓名不得少於 ' . CC_OWNER_MIN_LENGTH . ' 個字\n');
  define('MODULE_PAYMENT_CC_TEXT_JS_CC_NUMBER', '* 卡號不得少於 ' . CC_NUMBER_MIN_LENGTH . ' 位數\n');
  define('MODULE_PAYMENT_CC_TEXT_ERROR', '無效的信用卡!');
?>