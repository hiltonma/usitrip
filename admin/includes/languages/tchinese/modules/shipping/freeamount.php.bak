...
define('MODULE_SHIPPING_FREEAMOUNT_TEXT_WAY', 'Economy (7 - 9 Days)');
define('MODULE_SHIPPING_FREEAMOUNT_TEXT_ERROR', 'Only for a order $' . MODULE_SHIPPING_FREEAMOUNT_AMOUNT . ' minimum');
