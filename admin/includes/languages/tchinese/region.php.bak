...
define('TEXT_DELETE_CATEGORY_INTRO', 'Are you sure you want to delete this region?');
define('TEXT_INFO_HEADING_DELETE_CATEGORY', 'Delete Region');
...
/*comment by scs define('TEXT_PRODUCTS_IMAGE_SM_1', 'SM Image 1:');
...
define('HEADING_TITLE', 'Regions');
define('HEADING_TITLE_SEARCH', 'Search:');
define('HEADING_TITLE_GOTO', 'Go To:');

define('TABLE_HEADING_ID', 'ID');
define('TABLE_HEADING_REGIONS_PRODUCTS', 'Regions');
define('TABLE_HEADING_ACTION', 'Action');
define('TABLE_HEADING_STATUS', 'Status');

define('TEXT_PRODUCTS_DESTINATION', 'Products Destination');

define('TEXT_NEW_PRODUCT', 'New Product in &quot;%s&quot;');
define('TEXT_REGIONS', 'Regions:');
define('TEXT_SUBREGIONS', 'Subregions:');
...
define('TEXT_NO_CHILD_REGIONS_OR_PRODUCTS', 'Please insert a new category or product in this level.');
...
define('TEXT_EDIT_REGIONS_ID', 'Region ID:');
define('TEXT_EDIT_REGIONS_NAME', 'Region Name:');
define('TEXT_EDIT_REGIONS_IMAGE', 'Region Image:');
define('TEXT_EDIT_SORT_ORDER', 'Sort Order:');
define('TEXT_EDIT_REGIONS_HEADING_TITLE', 'Region heading title:');
define('TEXT_EDIT_REGIONS_DESCRIPTION', 'Region heading Description:');
define('TEXT_EDIT_REGIONS_TITLE_TAG', 'Region Title Meta Tag :');
define('TEXT_EDIT_REGIONS_DESC_TAG', 'Region Description Meta Tag :');
define('TEXT_EDIT_REGIONS_KEYWORDS_TAG', 'Region Key Word Meta Tag :');

define('TEXT_EDIT_REGIONS_SEO_DESCRIPTION','Region Seo Description');
define('TEXT_EDIT_REGIONS_LOGO_ALT_TAG','Region Logo Alt Tag');
define('TEXT_EDIT_REGIONS_FIRST_SENTENCE','Region First Sentence');

define('TEXT_INFO_COPY_TO_INTRO', 'Please choose a new category you wish to copy this product to');
define('TEXT_INFO_CURRENT_REGIONS', 'Current Categories:');

define('TEXT_INFO_HEADING_NEW_REGION', 'New Region');
define('TEXT_INFO_HEADING_EDIT_REGION', 'Edit Region');
define('TEXT_INFO_HEADING_DELETE_REGION', 'Delete Region');
define('TEXT_INFO_HEADING_MOVE_REGION', 'Move Region');
define('TEXT_INFO_HEADING_DELETE_PRODUCT', 'Delete Product');
define('TEXT_INFO_HEADING_MOVE_PRODUCT', 'Move Product');
define('TEXT_INFO_HEADING_COPY_TO', 'Copy To');

define('TEXT_DELETE_REGION_INTRO', 'Are you sure you want to delete this category?');
...
define('TEXT_MOVE_REGIONS_INTRO', 'Please select which category you wish <b>%s</b> to reside in');
define('TEXT_MOVE', 'Move <b>%s</b> to:');

define('TEXT_NEW_REGION_INTRO', 'Please fill out the following information for the new category');
define('TEXT_REGIONS_NAME', 'Region Name:');
define('TEXT_REGIONS_IMAGE', 'Region Image:');
define('TEXT_SORT_ORDER', 'Sort Order:');

define('TEXT_REGION_STATUS', 'Region Status:');
define('TEXT_REGION_AVAILABLE', 'Active');
define('TEXT_REGION_NOT_AVAILABLE', 'In Active');
define('TEXT_PRODUCT_REGULAR_TOUR', 'Regular Tour');
define('TEXT_PRODUCT_NOT_REGULAR_TOUR', 'Irregular Tour');

define('TEXT_PRODUCTS_REGION','Products Region:');
define('TEXT_PRODUCTS_DURATION_SELECT_CITY', 'Products City For Departure:');
define('TEXT_PRODUCTS_TYPE', 'Products Type:');
...
define('TEXT_PRODUCTS_AGENCY', 'Products Travel Agency:');

define('TEXT_PRODUCTS_NAME', 'Products Name:');
define('TEXT_PRODUCTS_DESCRIPTION', 'Products Description:');
define('TEXT_PRODUCTS_QUANTITY', 'Products Quantity:');
define('TEXT_PRODUCTS_MODEL', 'Products Model:');
define('TEXT_PRODUCTS_DURATION', 'Products Duration:');
define('TEXT_PRODUCTS_DEPARTURE_PLACE', 'Departure Places:');
...
define('EMPTY_REGION', 'Empty Region');

define('TEXT_HOW_TO_COPY', 'Copy Method :');
define('TEXT_COPY_AS_LINK', 'Link product');
define('TEXT_COPY_AS_DUPLICATE', 'Duplicate product');

define('ERROR_CANNOT_LINK_TO_SAME_REGION', 'Error: Can not link products in the same category.');
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Error: Catalog images directory is not writeable: ' . DIR_FS_CATALOG_IMAGES);
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Error: Catalog images directory does not exist: ' . DIR_FS_CATALOG_IMAGES);
define('ERROR_CANNOT_MOVE_REGION_TO_PARENT', 'Error: Region cannot be moved into child category.');
...
define('TEXT_REGION_COUNTRY', 'Region Country:');
