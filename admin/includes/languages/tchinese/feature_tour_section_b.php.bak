...
define('TEXT_OK_TO_DELETE', 'Are you sure you want to delete this Feature tour section display?');
define('TEXT_OPTION_ID', 'Feature section ID');
define('TEXT_OPTION_NAME', 'Duration');
define('TEXT_OPTION_SORTORDER', 'City Code');
define('TABLE_HEADING_CATEGORIES_ID','Category ID');
?>
