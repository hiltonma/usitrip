...
define('TEXT_PRODUCTS_DESTINATION', 'Attractions:'); // Products Destination
...
define('TEXT_PRODUCTS_PACKAGE_SPECIAL_NOTES', 'Tour Package Special Notes:');
...
define('TEXT_PRODUCTS_MIN_GUEST','參團最少人數:');
define('TEXT_PRODUCTS_BUY_TWO_GET_ONE_SURCHARGE','買二送一免費人員的附加費用');
define('TEXT_USE_BUY_TWO_GET_ONE_PRICE','是否使用買二送一公式計價');
...
define('TEXT_HEADING_SPL_NOTES','E-Ticket Special Notes:');  //Special Note:
define('TEXT_HEADING_TITLE_TOUR_CATEGORIZATION','Tour Categorization');
define('TEXT_HEADING_TITLE_ROOM_AND_PRICE','Room and Price');
...
define('TEXT_CALCULATE_RETAIL_PRICE','Calculate Retail Price');
define('TEXT_CALCULATE_RETAIL_PRICE_ATTRIBUTE','Cal. RP');
define('TEXT_CALCULATE_RETAIL_PRICE_OPRATION','Cal. RP');
...
define('TEXT_PRODUCTS_STOCK','庫存狀態:');
define('TEXT_PRODUCTS_IN_STOCK','正常');
define('TEXT_PRODUCTS_OUT_STOCK','已賣完');

define('TEXT_PRODUCTS_TOUR_TYPE_ICON', '顯示的類型標籤:');
define('TEXT_SOLDOUT_DATES', 'Sold out dates:');
define('TEXT_PRODUCTS_UPGRADE_TO', 'Upgrade to:'); //Products Model
define('TEXT_REMAINING_SEATS','本團座位剩餘情況:');
?>