...
define('TABLE_HEADING_FIRSTNAME', 'Chinese Name');
define('TABLE_HEADING_LASTNAME', 'English Name');
...
define('TABLE_HEADING_CREDIT_ISSUED','Credit Issued');
define('IMAGE_VIEW_CREDIT_HISTORY', 'View Credit History');
define('HEADING_ORDER_DATE', 'Date');
define('HEADING_ORDERS_NUMBER', 'Order No.');
define('HEADING_POINTS_STATUS', 'Tour code');
define('HEADING_POINTS_COMMENT', 'Comments');
define('HEADING_POINTS_TOTAL', 'Credit Amount');


define('MY_CREDITS_CURRENT_BALANCE', '<b>Credit total = </b> $%s');
//<b>Valued at :</b> %s .
?>