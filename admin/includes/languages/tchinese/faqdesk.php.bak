...
define('HEADING_TITLE', 'FAQDesk ... Category and FAQ Management');
...
define('TEXT_NEW_FAQDESK', 'FAQs in the category &quot;%s&quot;');
...
define('TEXT_FAQDESK_DATE_AVAILABLE', 'Date Available:');
...
define('TEXT_CATEGORIES_DESCRIPTION_NAME', 'Category Description:');
...
define('TEXT_DATE_FORMAT', 'Date formatted as:');

define('TEXT_SHOW_STATUS', 'Status');

define('TEXT_DELETE_IMAGE', 'Delete Image(s) ?');
define('TEXT_DELETE_IMAGE_INTRO', 'BEWARE: Deleting this/these image(s) will completely remove it/them. If you use this/these image(s) elsewhere, errors would occur!');
...
define('TEXT_FAQDESK_IMAGE_ONE', 'First Image:');
define('TEXT_FAQDESK_IMAGE_TWO', 'Second Image:');
define('TEXT_FAQDESK_IMAGE_THREE', 'Third Image:');

define('TEXT_FAQDESK_IMAGE_SUBTITLE', 'Image title for First Image:');
define('TEXT_FAQDESK_IMAGE_SUBTITLE_TWO', 'Image title for Second Image:');
define('TEXT_FAQDESK_IMAGE_SUBTITLE_THREE', 'Image title for Third Image:');
