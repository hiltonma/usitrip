...
define('HEADING_TITLE', 'Action Management');
define('HEADING_TITLE_REFERRAL', 'Referral Points Management');
define('HEADING_TITLE_REVIEW', 'Review Points Management');
define('HEADING_TITLE_FEEDBACK', 'Feedback Points Management');
define('HEADING_TITLE_QUE_ANS', 'Question-Answer Points Management');
define('HEADING_TITLE_TRAVELER_PHOTO', 'Traveler Photos Points Management');
...
define('TEXT_DEFAULT_REVIEWS_PHOTOS', 'Traveler Photos');
define('TEXT_TYPE_REFERRAL', 'Referral');
define('TEXT_TYPE_REVIEW', 'Review');
define('TEXT_DEFAULT_FEEDBACK_APPROVAL', 'Feedback');
define('TEXT_DEFAULT_ANSWER', 'Q&A');
...
define('EMAIL_TEXT_ORDER_NUMBER', 'Order Number£¨ÄúµÄ¶©µ¥ºÅÂë£©:');
