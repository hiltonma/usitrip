...
define('TEXT_ARTICLES_SEO_URL', 'Article SEO Url:');
define('TEXT_ARTICLES_IMAGE', 'Article Image:');
...
define('ERROR_SEO_URL_ALREADY_EXIST', 'Note: The Article SEO Url you entered is already exist for another article');
