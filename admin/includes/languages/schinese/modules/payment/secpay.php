<?php
/*
  $Id: secpay.php,v 1.1.1.1 2003/03/22 16:56:03 nickle Exp $
...
*/
  ...
  define('MODULE_PAYMENT_SECPAY_TEXT_DESCRIPTION', '信用卡测试：<br><br>CC#: 4444333322221111<br>到期日： Any');
  define('MODULE_PAYMENT_SECPAY_TEXT_ERROR_MESSAGE', '信用卡处理错误，请再试一次');
?>