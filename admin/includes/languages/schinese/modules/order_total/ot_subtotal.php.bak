<?php
/*
  $Id: ot_subtotal.php,v 1.1.1.1 2003/03/22 16:56:03 nickle Exp $
...
*/
  ...
  define('MODULE_ORDER_TOTAL_SUBTOTAL_TITLE', '小计');
  define('MODULE_ORDER_TOTAL_SUBTOTAL_DESCRIPTION', '订单小计');
?>