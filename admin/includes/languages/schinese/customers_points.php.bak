...
define('HEADING_TITLE_SEARCH', 'Search Id or Name or Email: ');

define('TABLE_HEADING_FIRSTNAME', 'First Name');
define('TABLE_HEADING_LASTNAME', 'Last Name');
define('TABLE_HEADING_DOB', 'Date of birth');
define('TABLE_HEADING_ACTION', 'Action');
define('TABLE_HEADING_POINTS', 'Points Earned');
define('TABLE_HEADING_POINTS_REDEEMED', 'Points Redeemed');
...
define('SUCCESS_DATABASE_UPDATED', 'Queue Success: Database has been successfully updated.');
