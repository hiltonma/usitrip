...
define('KEYWORD_DATETIME', 'Date/Time');

define('KEYWORD_COUNT', 'Count');
...
define('SIDEBAR_INFO_2', 'To delete keyword data from the database, click the button below:');
...
define('BUTTON_REFRESH', 'Display Report');
...
define('HEADING_MONTH_DATE', 'Month to Date');
define('HEADING_TYPE_MONTHLY', 'One Year');
define('HEADING_All_TIME', 'All Time');

define('HEADING_ONE_WEEK', 'Last Seven Days');
define('HEADING_LAST_MONTH', 'Last Month');
define('HEADING_YESTERDAY', 'Yesterday');
define('HEADING_TODAY', 'Today');

define('HEADING_DATE_RANGE', 'Date range');
