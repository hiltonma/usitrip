...
define('HEADING_TITLE_OPT', 'States List');

define('TABLE_HEADING_STATE_CODE', 'State Code');
define('TABLE_HEADING_ID', 'ID');
define('TABLE_HEADING_PRODUCT', 'Product Name');
define('TABLE_HEADING_OPT_NAME', 'States Name');
...
define('TEXT_OPTION_ID', 'State ID');
define('TEXT_OPTION_NAME', 'State Name');
define('TEXT_OPTION_SORTORDER', 'State Code');
?>
