...
define('TEXT_PROVIDERS_DISPLAY_STATUS_HIST', '此供应商是否使用我们的地接管理系统:');
define('TEXT_SEPARATE_TOUR_AND_TOUR_PACKAGE', 'Separate Tour and Tour Package:');
define('IMAGE_CREATE', 'Create Provider');
define('IMAGE_RESET_PSW', 'Reset Password');
define('PROVIDER_MAIL_FROM', '走四方网');
define('TXT_CAN_ISSUE_E_TICKET', 'Can Issue E-Ticket:');
define('CATEGORY_ETICKET', 'E-Ticket');
define('TXT_ETICKET_DEFAULT_COMMENT', '参团须知:');
