...
define('ERROR_BANNER_TITLE_REQUIRED', 'Error: Please check Product ID or Category ID.');
...
define('TEXT_INFO_HEADING_MOVE_PRODUCT', 'Move Banner');
define('TEXT_MOVE_PRODUCTS_INTRO', 'Please select which affiliate group you wish <b>%s</b> to reside in');
define('TEXT_MOVE', 'Move <b>%s</b> to:');
define('TEXT_INFO_CURRENT_CATEGORIES', 'Current Banner Group:');
