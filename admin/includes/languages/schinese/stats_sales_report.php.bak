<?php
/*
  $Id: stats_sales_report.php,v 1.3 2002/03/30 15:03:59 harley_vb Exp $
...
define('FILTER_STATUS', 'Order Status'); //added by azer 'cos was missing 
define('FILTER_VALUE', 'Display Choice'); //added by azer 'cos was missing
...
define('TABLE_HEADING_SIGNUPS', 'Customer Signup');
define('TABLE_HEADING_GROSS_PROFIT', 'Gross Profit');
define('TABLE_HEADING_GROSS_PROFIT_PERCENTAGE', 'Gross Profit<br>(%)');

define('TABLE_HEADING_CUSTOMERS_FROM', '客户来源：');
define('TABLE_HEADING_TIME_CLASS', '时间段：');
