...
define('TEXT_INFO_ORDERS_DEFAULT_SUBJECT_STRING', 'Orders Status Default Email Subject:');
define('TEXT_INFO_ORDERS_DEFAULT_COMMENT_STRING', 'Orders Status Default Email Comment:');

define('TITLE_FILTER', '筛选：');
define('TEXT_INFO_GROUPS', '所属组：');
define('TEXT_INFO_MANAGEMENT_GROUPS', '管理组');
