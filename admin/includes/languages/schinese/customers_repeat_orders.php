...
define('HEADING_TITLE', 'Repeat Customer Orders');
...
define('TABLE_HEADING_ORDER_NUMBER', '# Of Order');
define('TABLE_HEADING_ORDER_TOTAL', '订单总金额');

define('TABLE_HEADING_COUNTRY','国家/地区');
define('HEADING_FIRST_ORDERS_DATE','下单日期');
?>
