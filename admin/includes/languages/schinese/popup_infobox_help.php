...
define('TEXT_INFOBOX_HELP_COLUMN', 'Enter select <b>left</b> or <b>right</b><br> for the Infobox displayed in the left or right column.<br><br>By default it set to <b>left</b>');
...
define('TEXT_INFOBOX_HELP_ACTIVE', 'Either select <b>yes</b> or <b>no</b> to display the Infobox (yes) or not (no).<br><br>By default it set to <b>yes</b>');
define('TEXT_INFOBOX_HELP_TEMPLATE', 'This must represent the file name of the box, where the functions for your boxes are located. If you have a special file for your function, it should be in <u>catalog/templates/(template name)/boxes.tpl.php</u> <br><br> It must be lowercase.<br><br>For example:<br>Your new Infobox templete function file is standard, put <b>infobox</b> and this will use the standard fuctions. If you use special funcitons for your infobox, put <b>box.tpl.php</b> here and place the file in <u>catalog/templates/(template name)/boxes.tpl.php</u>.');
