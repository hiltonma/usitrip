...
define('TABLE_HEADING_STATISTICS', '显示');
define('TABLE_HEADING_STATISTICS1', '/点击');
...
define('TEXT_BANNERS_BANNER_NOTE', '<b>Banner Notes:</b><ul><li>NewsLetter Email、Orders Email和Tours Feedback类只能加Image或HtmlText格式的广告；</li></ul><ul>Use an image or HTML text for the banner - not both.</li><li>HTML Text has priority over an image</li></ul>');
...
define('TEXT_BANNERS_SORT_ORDER','Banner Sort Order');
define('TEXT_BANNERS_LANGUAGE_DISPLAY','Banner for site');
define('TABLE_HEADING_SORT_ORDER', '排序');
define('TABLE_HEADING_LANGUAGE_DISPLAY_SITE','Site');

define('TABLE_HEADING_ORDERS_NUM','订单数');
define('TABLE_HEADING_ORDERS_SUM','订单额');
?>
