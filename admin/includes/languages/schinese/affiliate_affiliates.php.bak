...
define('TABLE_HEADING_COMMISSION','Commission Rate');
...
define('TABLE_HEADING_TOTAL_COMMISSION', 'Total Commission');
define('TABLE_HEADING_PAID_COMMISSION', 'Paid Commission');
define('TABLE_HEADING_PENDING_COMMISSION', 'Pending Commision');

define('ENTRY_API_CATEGORIES_ID', '合作API的产品目录');
?>
