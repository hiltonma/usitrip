...
define('TEXT_MAINPAGE_MODULES', '<b>Select Modules for Mainpage</b>');
...
define('ERROR2', 'Error! 02  You are installing a AlgoZONE template that is not compatible with this version of CRE loaded6. <br> Please contact AlgoZONE for a 100 series, version of the install');
