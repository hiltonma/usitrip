...
define('TEXT_DISPLAY_NUMBER_OF_ORDERS', '顯示 <b>%d</b> 至 <b>%d</b> (總共 <b>%d</b> 條記錄)');
...
define('TEXT_TOTAL_OF_ROOMS','總房間數(Total Number of Rooms):');

define('TEXT_OF_ADULTS_IN_ROOM1','第一房間內成人數(Number of Adults in Room 1):');
define('TEXT_OF_ADULTS_IN_ROOM2','第二房間內成人數(Number of Adults in Room 2):');
define('TEXT_OF_ADULTS_IN_ROOM3','第三房間內成人數(Number of Adults in Room 3):');
define('TEXT_OF_ADULTS_IN_ROOM4','第四房間內成人數(Number of Adults in Room 4):');
define('TEXT_OF_ADULTS_IN_ROOM5','第五房間內成人數(Number of Adults in Room 5):');
define('TEXT_OF_ADULTS_IN_ROOM6','第六房間內成人數(Number of Adults in Room 6):');
define('TEXT_OF_ADULTS_IN_ROOM7','第七房間內成人數(Number of Adults in Room 7):');
define('TEXT_OF_ADULTS_IN_ROOM8','第八房間內成人數(Number of Adults in Room 8):');
define('TEXT_OF_ADULTS_IN_ROOM9','第九房間內成人數(Number of Adults in Room 9):');
define('TEXT_OF_ADULTS_IN_ROOM10','第十房間內成人數(Number of Adults in Room 10):');
define('TEXT_OF_ADULTS_IN_ROOM11','第十一房間內成人數(Number of Adults in Room 11):');
define('TEXT_OF_ADULTS_IN_ROOM12','第十二房間內成人數(Number of Adults in Room 12):');
define('TEXT_OF_ADULTS_IN_ROOM13','第十三房間內成人數(Number of Adults in Room 13):');
define('TEXT_OF_ADULTS_IN_ROOM14','第十四房間內成人數(Number of Adults in Room 14):');
define('TEXT_OF_ADULTS_IN_ROOM15','第十五房間內成人數(Number of Adults in Room 15):');

define('TEXT_OF_CHILDREN_IN_ROOM1','第一房間內兒童數(Number of Children in Room 1):');
define('TEXT_OF_CHILDREN_IN_ROOM2','第二房間內兒童數(Number of Children in Room 2):');
define('TEXT_OF_CHILDREN_IN_ROOM3','第三房間內兒童數(Number of Children in Room 3):');
define('TEXT_OF_CHILDREN_IN_ROOM4','第四房間內兒童數(Number of Children in Room 4):');
define('TEXT_OF_CHILDREN_IN_ROOM5','第五房間內兒童數(Number of Children in Room 5):');
define('TEXT_OF_CHILDREN_IN_ROOM6','第六房間內兒童數(Number of Children in Room 6):');
define('TEXT_OF_CHILDREN_IN_ROOM7','第七房間內兒童數(Number of Children in Room 7):');
define('TEXT_OF_CHILDREN_IN_ROOM8','第八房間內兒童數(Number of Children in Room 8):');
define('TEXT_OF_CHILDREN_IN_ROOM9','第九房間內兒童數(Number of Children in Room 9):');
define('TEXT_OF_CHILDREN_IN_ROOM10','第十房間內兒童數(Number of Children in Room 10):');
define('TEXT_OF_CHILDREN_IN_ROOM11','第十一房間內兒童數(Number of Children in Room 11):');
define('TEXT_OF_CHILDREN_IN_ROOM12','第十二房間內兒童數(Number of Children in Room 12):');
define('TEXT_OF_CHILDREN_IN_ROOM13','第十三房間內兒童數(Number of Children in Room 13):');
define('TEXT_OF_CHILDREN_IN_ROOM14','第十四房間內兒童數(Number of Children in Room 14):');
define('TEXT_OF_CHILDREN_IN_ROOM15','第十五房間內兒童數(Number of Children in Room 15):');

define('TEXT_TOTLE_OF_ROOM1','第一房間總費用(Subtotal 1):');
define('TEXT_TOTLE_OF_ROOM2','第二房間總費用(Subtotal 2):');
define('TEXT_TOTLE_OF_ROOM3','第三房間總費用(Subtotal 3):');
define('TEXT_TOTLE_OF_ROOM4','第四房間總費用(Subtotal 4):');
define('TEXT_TOTLE_OF_ROOM5','第五房間總費用(Subtotal 5):');
define('TEXT_TOTLE_OF_ROOM6','第六房間總費用(Subtotal 6):');
define('TEXT_TOTLE_OF_ROOM7','第七房間總費用(Subtotal 7):');
define('TEXT_TOTLE_OF_ROOM8','第八房間總費用(Subtotal 8):');
define('TEXT_TOTLE_OF_ROOM9','第九房間總費用(Subtotal 9):');
define('TEXT_TOTLE_OF_ROOM10','第十房間總費用(Subtotal 10):');
define('TEXT_TOTLE_OF_ROOM11','第十一房間總費用(Subtotal 11):');
define('TEXT_TOTLE_OF_ROOM12','第十二房間總費用(Subtotal 12):');
define('TEXT_TOTLE_OF_ROOM13','第十三房間總費用(Subtotal 13):');
define('TEXT_TOTLE_OF_ROOM14','第十四房間總費用(Subtotal 14):');
define('TEXT_TOTLE_OF_ROOM15','第十五房間總費用(Subtotal 15):');

define('TEXT_BED_OF_ROOM1','第一房間床型(Bed type 1):');
define('TEXT_BED_OF_ROOM2','第二房間床型(Bed type 2):');
define('TEXT_BED_OF_ROOM3','第三房間床型(Bed type 3):');
define('TEXT_BED_OF_ROOM4','第四房間床型(Bed type 4):');
define('TEXT_BED_OF_ROOM5','第五房間床型(Bed type 5):');
define('TEXT_BED_OF_ROOM6','第六房間床型(Bed type 6):'); 

define('TEXT_BED_STANDARD','不限制');
define('TEXT_BED_KING','兩張標準床');
define('TEXT_BED_QUEEN','一張King-sized大床');

define('TEXT_TOTLE_OF_ROOM_STRING_CHECK','房間總費用');
...
<TD><STRONG>Pick-up Time<BR><SPAN lang=ZH-CN style=\"FONT-SIZE: 10.5pt; FONT-FAMILY: SimSun; mso-bidi-font-size: 12.0pt; mso-ascii-font-family: \'Times New Roman\'; mso-hansi-font-family: \'Times New Roman\'; mso-bidi-font-family: \'Times New Roman\'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA\">上車</SPAN><SPAN lang=ZH-TW style=\"FONT-SIZE: 10.5pt; FONT-FAMILY: PMingLiU; mso-bidi-font-size: 12.0pt; mso-ascii-font-family: \'Times New Roman\'; mso-hansi-font-family: \'Times New Roman\'; mso-bidi-font-family: \'Times New Roman\'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-TW; mso-bidi-language: AR-SA\">時間</SPAN></STRONG></TD>
<TD><STRONG>Itinerary<BR><SPAN lang=ZH-TW style=\"FONT-SIZE: 10.5pt; FONT-FAMILY: PMingLiU; mso-bidi-font-size: 12.0pt; mso-ascii-font-family: \'Times New Roman\'; mso-hansi-font-family: \'Times New Roman\'; mso-bidi-font-family: \'Times New Roman\'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-TW; mso-bidi-language: AR-SA\">線路</SPAN></STRONG></TD>
...
define('BOX_HEADING_REWARDS4FUN', '儅煦奪燴');
...
define('EMAIL_TEXT_DEAR_A','尊敬的顧客');

define('SHOPPING_CART_CALL','走四方網購物車提醒！');

define('POINTS_CALL_MAIL','走四方積分提醒！');
define('MY_POINTS_CURRENT_BALANCE', '總積分： %s  價值： %s ');

###################### Tours Vote System ##########################
define('TOURS_TOTE_SYSTEM','走四方調查系統');

define('DB_UPDATE_SYSTEM','數據庫資料更新');

define('EMAIL_TRACK_SYSTEM','電子郵件跟蹤系統');
...
define('TEXT_SAVINGS','第一次訂購優惠可達<span style="color: rgb(241, 115, 13);">3%-6%</span>！<br>第二次訂購優惠可達<span style="color: rgb(241, 115, 13);">4%-7%</span>！<br>訂購超過兩次優惠可達<span style="color: rgb(241, 115, 13);">5%-8%</span>！');

define('TFF_POINTS_DESCRIPTION','走四方積分兌換說明');
define('TFF_POINTS_DESCRIPTION_CONTENT','您可以在訂購走四方網的旅遊行程時使用您的積分，獲取一定比例的折扣。<br>
兌換方法：當您在預定某行程時，在結帳頁面，“積分兌換”部分，您可以看到您目前的積分總數及訂購此行程可以使用的最高積分數及節省的金額。點擊“兌換積分”按鈕，系統就將自動扣住您的積分，並減去相應的金額，展示積分折扣後的訂單總價。');
...
define('E_TICKET_SMS','您的訂單%s的電子票已發送到郵箱，它是您的參團憑證，請打印出來。登陸走四方網至“我的走四方”查閱詳情--usitrip.com ');
...
define('ATTR_THEME_PARK_INCLUDE_NOTE', '已經付清主題公園門票費用, 請保留座位。');
define('ATTR_THEME_PARK_EXCLUDE_NOTE', '請不為客人保留座位。');
