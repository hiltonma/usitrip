...
*/
  ...
  $graph = new PHPlot(600, 400, 'images/graphs/banner_daily-' . $banner_id . '.' . $banner_extension);
  $graph->use_ttf =1;
  ...
  $graph->SetTitle(sprintf(TEXT_BANNERS_DAILY_STATISTICS, iconv('GB2312','UTF-8'.'//IGNORE',$banner['banners_title']), strftime('%B', mktime(0,0,0,$month)), $year));
