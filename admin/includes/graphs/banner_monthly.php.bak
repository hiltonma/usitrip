...
*/
  ...
  $graph = new PHPlot(600, 400, 'images/graphs/banner_monthly-' . $banner_id . '.' . $banner_extension);
  $graph->use_ttf =1;
  ...
  $graph->SetTitle(sprintf(TEXT_BANNERS_MONTHLY_STATISTICS, iconv('GB2312','UTF-8'.'//IGNORE',$banner['banners_title']), $year));
