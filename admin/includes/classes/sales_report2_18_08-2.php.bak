...
*/
  ...
  class sales_report {
    ...
    function getNext() {
     ...
     //amit commeted   //$rqOrders = tep_db_query($this->queryOrderCnt . " WHERE o.date_purchased >= '" . tep_db_input(date("Y-m-d\TH:i:s", $sd)) . "' AND o.date_purchased < '" . tep_db_input(date("Y-m-d\TH:i:s", $ed)) . "'" . $filterString);
	  ...
	  if(isset($_GET['group_country']) && $_GET['group_country'] == '1' ){	
     	if($_GET['detail']==0){
	 	$rqItems = tep_db_query($this->queryItemCnt . " AND o.date_purchased >= '" . tep_db_input(date("Y-m-d\TH:i:s", $sd)) . "' AND o.date_purchased < '" . tep_db_input(date("Y-m-d\TH:i:s", $ed)) . "'" . $filterString . " group by o.customers_country");
	 	}else{
			$rqItems = tep_db_query($this->queryItemCnt . " AND o.date_purchased >= '" . tep_db_input(date("Y-m-d\TH:i:s", $sd)) . "' AND o.date_purchased < '" . tep_db_input(date("Y-m-d\TH:i:s", $ed)) . "'" . $filterString . " group by o.customers_country,pid " . $this->sortString );
		}	
	  ...
	  */
	  if(isset($_GET['group_country']) && $_GET['group_country'] == '1' && $_GET['detail']==0){	
     	//amit added to external query
		//$this->queryOrderExternal = "SELECT count(o.orders_id) as order_cnt FROM " . TABLE_ORDERS . " as o , " . TABLE_ORDERS_TOTAL . " as ot ";
			
		  $this->queryOrderExternal = "SELECT count(o.orders_id) as order_ext_cnt FROM " . TABLE_ORDERS . " as o , " . TABLE_ORDERS_TOTAL . " as ot ";
							
			$this->queryOrderExternal .= " WHERE o.orders_id = ot.orders_id AND ot.class = 'ot_total' AND o.date_purchased >= '" . tep_db_input(date("Y-m-d\TH:i:s", $sd)) . "' AND o.date_purchased < '" . tep_db_input(date("Y-m-d\TH:i:s", $ed)) . "'";
