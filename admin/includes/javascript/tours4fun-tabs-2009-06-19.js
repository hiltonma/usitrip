...
function sendFormData(idForm, dataSource, divID, ifLoading)
{
  ...
  if(XMLHttpRequestObject)
  {
    ...
    for(i=0; i<document.getElementById(idForm).elements.length - 1; i++)
    {
					...
					if(document.getElementById(idForm).elements[i].value != ''){
					  if(strReplaceTemp == 'page'){
						...
						if(hashString.search("/at-")=='-1' && hashString.search("/#at-")=='-1'){
							hashString += 'at-'+document.getElementById(idForm).elements[i].value+'/';  
						}
					  }else if(strReplaceTemp == 'top_attractions1'){
						if(hashString.search("/vat-")=='-1' && hashString.search("/#vat-")=='-1'){
							hashString += 'vat-'+document.getElementById(idForm).elements[i].value+'/';  
						}	
	  ...
	  //amit added for check history end	
		//howard fixed
		if( ((document.getElementById(idForm).elements[i].type=='checkbox' || document.getElementById(idForm).elements[i].type=='radio') && document.getElementById(idForm).elements[i].checked==true) || (document.getElementById(idForm).elements[i].type!='checkbox' && document.getElementById(idForm).elements[i].type!='radio' )){
