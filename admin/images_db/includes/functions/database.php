...
*/
  ...
  function tep_db_connect($server = DB_SERVER, $username = DB_SERVER_USERNAME, $password = DB_SERVER_PASSWORD, $database = DB_DATABASE_IMAGES_DB, $link = 'db_link') {
    global $$link;
  ...
  function tep_db_error($query, $errno, $error) {
    //die('<font color="#000000"><b>' . $errno . ' - ' . $error . '<br><br>' . $query . '<br><br><font color="#ff0000">[TEP STOP]</font><br><br></b></font>');
    die('<font color="#000000"><b>' . $errno . ' - ' . $error . '<br><br>' . $query . '<br><br><font color="#ff0000">'.TEP_DB_ERRORR.'</font><br><br></b></font>');
  }
...
// End osC Explain Query Modifications
 ...
 function tep_db_table_exists($table, $link = 'db_link') {
    $result = tep_db_query("show table status from `" . DB_DATABASE_IMAGES_DB . "`");
