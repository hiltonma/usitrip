 ...
 //initialize varible
  ...
  $links_image = '';
   ...
   if ($test_image_local == '0'){
    $links_image = tep_links_image_resize_external($src, $listing['links_title'], LINKS_IMAGE_WIDTH, LINKS_IMAGE_HEIGHT, $parameters);
  }
  ...
  $links_image = tep_links_image_resize_local($src_web_local, $listing['links_title'], LINKS_IMAGE_WIDTH, LINKS_IMAGE_HEIGHT, $parameters);
    }

   if ($test_image_local == '1'){
  $links_image = tep_links_image_resize_local($src, $listing['links_title'], LINKS_IMAGE_WIDTH, LINKS_IMAGE_HEIGHT, $parameters);
   }
 return($links_image);
}
