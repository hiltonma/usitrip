...
//Howard 删除已下单给地接记录表 end }
  ...
  $email_subject = STORE_OWNER." 参团凭证 订单号：".(int)$oID." ";
	...
	if(tep_not_null($productInfo)){
		...
		您还可以通过访问<a href=\"http://www.usitrip.com/login.php\">http://www.usitrip.com/login.php</a> ，点击「查看」浏览您的预订情况，并点击「参团凭证」按钮查看您的参团凭证。<br/>
		如果您尚未为您的预订购买<a href=\"http://www.usitrip.com/tour_america_need.php\">旅游保险</a>，我们将及时提醒您购买。购买<a href=\"http://www.usitrip.com/tour_america_need.php\">旅游保险</a>,是在因紧急医疗事故、签证申请失败、天气限制、航班取消或其他人为原因等取消或中断旅行时获得旅行费用补偿的可靠方式。我们强烈推荐您为旅行中可能出现的突发事故做好准备。险别选项信息请参阅<a href=\"http://www.usitrip.com/tour_america_need.php\">旅游保险</a>.<br/><br/>
		感谢您的购买，并祝您旅途愉快！<br/>
		...
		$eticket_notify_email_content .="
		You may also access your E-Ticket by logging into your account:<a href=\"http://www.usitrip.com/login.php\">http://www.usitrip.com/login.php</a> 'view' your previous reservations and click 'e-ticket' button.<br/>
		We would like to quickly remind you to purchase <a href=\"http://www.usitrip.com/login.php\">Travel Insurance </a>for your reservation, if you have not done so yet. Purchasing <a href=\"http://www.usitrip.com/login.php\">Travel Insurance</a> is a reliable way to recover your tour expenses in the event of cancellation or interruption of your tour (i.e. medical emergencies, Visa applications, weather restrictions, flight cancellations, or other personal reasons). We strongly encourage our travelers to be prepared to expect the unexpected during their travel. Please visit <a href=\"http://www.usitrip.com/login.php\">Travel Insurance</a> for insurance coverage options.<br/>
