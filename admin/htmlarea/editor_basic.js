...
//  ['strikethrough','subscript','superscript','separator'],
    ...
    ['HorizontalRule','Createlink','InsertImage','linktofile','InsertTable','separator'],
//  ['custom1','custom2','separator'],
    ['translation','custom3','separator'],
    ['popupeditor','preview','separator'],
    ['htmlmode','maxidvd'],
//    ['about'],
...
this.btnList = {
    ...
    "maxidvd":           ['maxidvd',         ' Version ',            'editor_action(this.id)',  'ed_about.gif'],
...
function editor_action(button_id) {
  ...
  if (cmdID == 'popupeditor') {
    window.open(_editor_url + "popups/fullscreen_basic.html?"+objname,
                'FullScreen',
...
// end insert by lvn
  ...
  if (fileLink) { editor_insertHTML(objname, unescape( fileLink) ); }
    ...
    alert(" MaxiDVD - HTML WYSIWYG Basic Editor v1.6 for osCommerce ");
  }
  ...
  // Custom3
    ...
    editor_insertHTML(objname, "<P align=center><FONT color=#3300ff size=6><STRONG><IMG alt=\" Or our Store Logo! \"  hspace=0 src=\"http://www.kmart.com.au/images/top/KmartLogo.gif\" align=baseline border=0><BR></STRONG><FONT color=#000000 size=3>It's <STRONG>EASY</STRONG> to add buttons that insert text and </FONT><FONT color=#3300ff size=6><STRONG>HTML<BR></STRONG></FONT><FONT face=\"Verdana, Arial, Helvetica, sans-serif\" size=2>Good for Pre-Writting&nbsp;Custom or Repetitive customer emails replies ect...</FONT>");
  }
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert table
      ...
      showModalDialog(_editor_url + "popups/insert_table_basic.html?"+objname,
                                 window,
                                 "resizable: yes; help: no; status: no; scroll: no; ");
    }
