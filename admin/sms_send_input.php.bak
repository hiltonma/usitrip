...
$smsData['ItineraryEnd']['content'] = '您的行程已结束，希望你对行程满意，如有意见或建议，请联系我们的客服；邀您再次登录www.usitrip.com,将竭诚为您服务！';

$smsData['NoLogin']['title'] = '用户半年没有登录-短信问候并邀请再次登录';
$smsData['NoLogin']['change'] = 1;
$smsData['NoLogin']['content'] = '您的已经半年没有登陆我们的网站；邀您再次登录www.usitrip.com,如有意见或建议，请联系我们的客服，将竭诚为您服务！';

$smsData['NoOrder']['title'] = '用户半年没有下单-短信问候并邀请再次登录';
$smsData['NoOrder']['change'] = 1;
$smsData['NoOrder']['content'] = '您的已经半年没有下单了；邀您再次登录www.usitrip.com,如有意见或建议，请联系我们的客服，将竭诚为您服务！';
