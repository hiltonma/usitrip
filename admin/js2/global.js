$(function(){
	...
	//conSwitch
	$(".conSwitch").toggle(function(){
	    var idName = $(this).attr("id");
	    var tmp = idName.substring(idName.lastIndexOf("_"));
	    $("#ConSwitchCon"+tmp).slideUp();
	    $(this).addClass("conSwitchShow");
	},function(){
	    var idName = $(this).attr("id");
	    var tmp = idName.substring(idName.lastIndexOf("_"));
	    $("#ConSwitchCon"+tmp).slideDown();
	    $(this).removeClass("conSwitchShow");
	});
