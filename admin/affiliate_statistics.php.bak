...
*/
  ...
  select count(*) as count, sum(affiliate_value) as total, sum(affiliate_payment) as payment from
    ...
    o.orders_id = a.affiliate_orders_id and a.affiliate_isvalid = 1 and
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="4" cellspacing="2" class="dataTableContent">
              <center>
                <tr>
                  <td width="35%" align="right" class="dataTableContent">
				  <?php
				  //amit added 
				  	$customerdetails = tep_get_customers_info($affiliate['affiliate_id']);
					...
					$affiliate['affiliate_date_account_created'] = $customerdetails['customers_info_date_account_created']; 
					 
				  ?>
				  <b><?php echo TEXT_AFFILIATE_NAME; ?></b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                ...
                <tr>
                  <td align="right" class="dataTableContent" colspan="4"><?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_CLICKS, 'acID=' . $HTTP_GET_VARS['acID']) . '">' . tep_image_button('button_affiliate_clickthroughs.gif', IMAGE_CLICKTHROUGHS) . '</a> <a href="' . tep_href_link(FILENAME_AFFILIATE_SALES, 'acID=' . $HTTP_GET_VARS['acID']) . '">' . tep_image_button('button_affiliate_sales.gif', IMAGE_SALES) . '</a> <a href="' . tep_href_link(FILENAME_AFFILIATE_PAYMENT, 'acID=' . $HTTP_GET_VARS['acID']) . '">' . tep_image_button('button_affiliate_payment.gif', 'Payment Report') . '</a> <a href="' . tep_href_link(FILENAME_AFFILIATE_REFERRAL_REPORT, 'acID=' . $HTTP_GET_VARS['acID']) . '">' . tep_image_button('button_affiliate_referral report.gif', 'Referral Report') . '</a>'; ?></td>
                </tr>
              </center>
            </table></td>
          </tr>
