...
*/
  ...
  if($_GET['ajax']=="true"){
  	...
  	$remark = new Remark('affiliate_summary');
  ...
  $extra_aff_fileter_where = " where affiliate_homepage != '' ";
  $extra_aff_fileter_and_where = " and a.affiliate_homepage != '' ";
  ...
  $affiliate_clickthroughs_raw = "select count(*) as count from " . TABLE_AFFILIATE_CLICKTHROUGHS . " as ac, " . TABLE_AFFILIATE . " as a where a.affiliate_id = ac.affiliate_id ".$extra_aff_fileter_and_where." ";
...
*/
 $affiliate_sales_raw = "
  select count(*) as count, sum(affiliate_value) as total, sum(affiliate_payment) as payment
            from " . TABLE_AFFILIATE_SALES . " ass, 
            " . TABLE_ORDERS . " o, " . TABLE_AFFILIATE . "  a  
            where 
            o.orders_status >= " . AFFILIATE_PAYMENT_ORDER_MIN_STATUS . " and
            o.orders_id = ass.affiliate_orders_id and ass.affiliate_id = a.affiliate_id ".$extra_aff_fileter_and_where."  ";
  ...
  $affiliates_raw = "select count(*) as count from " . TABLE_AFFILIATE . " ".$extra_aff_fileter_where." ";
...
//echo $login_id;
include DIR_FS_CLASSES . 'Remark.class.php';
$listrs = new Remark('affiliate_summary');
