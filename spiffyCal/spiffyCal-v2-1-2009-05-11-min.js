...
this.enable=enable;this.JStoRunOnSelect='';this.JStoRunOnClear='';this.JStoRunOnCancel='';this.hideCombos=false;function makeCalendar(intWhatMonth,intWhatYear,bViewOnly){if(bViewOnly){intWhatMonth-=1;}
...
strHold='<table border="0" cellspacing="0" cellpadding="0" style="width:auto"><tr><td><input class="cal-TextBox"  name="'+this.textBoxName+'"'+strTemp+' size="16"  value="'+this.getSelectedDate()+'"></td>';if(!scIE){strTemp=' href="javascript:calClick();return false;" ';}
else{strTemp='';}
if((this.focusClick==false)||(this.focusClick==true&&this.hideButton==false)){strHold+='<td><a class="so-BtnLink"'+strTemp;strHold+=' onmouseover="calMgr.swapImg('+this.varName+',\'.imgOver\',false);" ';strHold+='onmouseout="calMgr.swapImg('+this.varName+',\'.imgUp\',false);" ';strHold+='onclick="calMgr.swapImg('+this.varName+',\'.imgDown\',true);';strHold+=this.varName+'.show();">';strHold+='<img align="absmiddle" border="0" name="'+this.btnName+'" src="'+strBtnImg+'" style="cursor: pointer; cursor: hand; margin-top:2px; margin-bottom:2px;"  width="'+strBtnW+'" height="'+strBtnH+'"></a></td></tr></table>';}
